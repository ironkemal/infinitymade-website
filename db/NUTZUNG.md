...
**Erzeugt:** 2026-09-18 · 89 Tabellen · Quelle: db/SCHEMA.sql (Stand 2026-09-18), funktionen/INDEX.json (erzeugt 2026-09-18)
...
**Schreibt (3):** `deleteAerzte()` [delete] — dashboard.js:15550 · `editAerzte()` [update] — dashboard.js:15559 · `resolveOrCreateArzt()` [insert/update] — api-backend/lib/arzt-registry.js:55
...
**Schreibt (1):** `saveAnamnese()` [insert/update] — dashboard.js:15155
...
**Schreibt (2):** `fmt()` [delete/insert/update] — dashboard.js:10708 · `renderB2B()` [delete] — dashboard.js:11590
...
**Schreibt (16):** `bindeTermin()` [update] — module/verordnung-termine.js:122 · `cancelRequestBookings()` [update] — api-backend/booking/cancel-request.js:3 · `createBookingsFromRequestFactory()` [insert] — api-backend/booking/from-request.js:17 · `doMoveBooking()` [update] — dashboard.js:5318 · `handleSessionDrop()` [insert] — dashboard.js:3863 · `handleTerminStarten()` [update] — dashboard.js:4364 · `initBkGroupPatientAutocomplete()` [insert] — dashboard.js:4851 · `korrigiereNoShow()` [update] — module/booking-status-korrektur.js:68 · `loadGroupParticipants()` [update] — dashboard.js:4735 · `loeseTermin()` [update] — module/verordnung-termine.js:133 · `markArrivedHandler()` [update] — dashboard.js:4226 · `markiereNichtErschienen()` [update] — module/termin-nicht-erschienen.js:105 · `openBookingActionModal()` [update] — dashboard.js:3242 · `saveFahrtEndHandler()` [update] — dashboard.js:4270 · `saveFahrtStartHandler()` [update] — dashboard.js:4143 · `uebernimmSlot()` [insert] — module/warteliste-nachruecker.js:198

**Liest (41):** `_terminBearbeiten()`, `ausgefalleneEinheiten()`, `calculateSessionInfo()`, `escapeHtml()`, `fmt()`, `frag()`, `frageNachrueckerAb()`, `gelernteDauer()`, `getAvailableSlots()`, `heuteAktualisieren()`, `horizonDays()`, `initCalendar()`, `initCalendar()`, `ladeBescheinigungTermine()`, `ladeKommendeTermineDesPatienten()`, `ladePatientenkontext()`, `ladePatientTermine()`, `ladePodoTermine()`, `ladeTerminVollstaendig()`, `ladeVerlauf()` … +21

**Dateien:** `api-backend/billing/api/ausfall.routes.js`, `api-backend/billing/api/warteliste.routes.js`, `api-backend/billing/statistik/therapeuten.js`, `api-backend/booking/cancel-request.js`, `api-backend/booking/from-request.js`, `api-backend/server.js`, `api/admin/data.js`, `booking.js`, `dashboard.js`, `kalender.js`, `module/behandlungsbestaetigung.js`, `module/booking-status-korrektur.js`, `module/fussbefund.js`, `module/kalender-monat.js`, `module/kalender-woche.js`, `module/patient-termine.js`, `module/patientenkarte.js`, `module/podologie-abrechnung.js`, `module/rechnung-editor.js`, `module/rechnung-editor.test.js`, `module/rechnung-verordnung.js`, `module/signal.js`, `module/termin-aktionen.js`, `module/termin-dauer.js`, `module/termin-heute.js`, `module/termin-laden.js`, `module/termin-nicht-erschienen.js`, `module/termin-patient-bezug.js`, `module/verordnung-detail.js`, `module/verordnung-termine.js`, `module/warteliste-nachruecker.js`
...
**Schreibt (3):** `fmt()` [delete/insert] — dashboard.js:10708 · `loadEmpHours()` [delete/insert] — dashboard.js:11331 · `renderHoursGrid()` [delete/insert] — dashboard.js:10077
...
**Schreibt (5):** `bindBusiness()` [insert/update] — onboarding.js:388 · `deleteBusiness()` [delete] — dashboard.js:16612 · `ensureBusinessCoords()` [update] — dashboard.js:20310 · `toggleStandortDay()` [update] — dashboard.js:10053 · `wireBusinessModal()` [insert/update] — dashboard.js:16529
...
**Schreibt (3):** `fmt()` [delete] — dashboard.js:10708 · `loadIntegrations()` [delete] — kalender.js:770 · `loadSettings()` [delete] — dashboard.js:12144
...
**Schreibt (1):** `saveSpecialDays()` [upsert] — dashboard.js:10275
...
**Schreibt (1):** `saveDataSharing()` [upsert] — dashboard.js:16375
...
**Schreibt (10):** `_enterAnsichtEditMode()` [update] — dashboard.js:12795 · `commit()` [update] — dashboard.js:13027 · `deleteVorlage()` [delete] — dashboard.js:12995 · `duplicateVorlage()` [insert] — dashboard.js:13004 · `fmt()` [delete/insert/update] — dashboard.js:10708 · `openVorlagenAnsicht()` [update] — dashboard.js:12705 · `saveVorlage()` [insert/update] — dashboard.js:12965 · `seedDefaultVorlagen()` [insert] — dashboard.js:13063 · `seedMissingVorlagen()` [insert] — dashboard.js:13069 · `startVorlagenInlineRename()` [update] — dashboard.js:13020
...
**Schreibt (2):** `fmt()` [insert] — dashboard.js:10708 · `loadPatientDetailMails()` [update] — dashboard.js:8835
...
**Schreibt (4):** `fmt()` [delete/upsert] — dashboard.js:10708 · `renderEmpStandortList()` [delete/upsert] — dashboard.js:10886 · `renderOtherStandortEmps()` [upsert] — dashboard.js:10739 · `saveEmpPermissions()` [upsert] — dashboard.js:10987
...
**Schreibt (2):** `fmt()` [delete/insert] — dashboard.js:10708 · `saveEmpPermissions()` [delete/insert] — dashboard.js:10987
...
**Schreibt (4):** `fmt()` [delete/insert] — dashboard.js:10708 · `loadEmpServices()` [delete/insert] — dashboard.js:11423 · `normName()` [insert] — onboarding.js:599 · `syncServices()` [insert] — onboarding.js:618
...
**Schreibt (3):** `saveFahrtEndHandler()` [upsert] — dashboard.js:4270 · `saveFahrtStartHandler()` [upsert] — dashboard.js:4143 · `toLocal()` [delete/update] — dashboard.js:18002
...
**Schreibt (3):** `frageZahlungsstatus()` [update] — module/rechnung-zahlung.js:87 · `markiereRechnungBezahlt()` [update] — module/rechnung-zahlung.js:68 · `saveInvoice()` [insert/update] — dashboard.js:14720
...
**Liest (4):** `baueBegleitzettel()`, `kostentraegerIkAufloesen()`, `ladeAnnahmestelle()`, `ladeKostentraegerNamen()`
...
**Schreibt (5):** `beantworteAltbestand()` [update] — module/verordnung-podo.js:709 · `handleDirectAusfallrechnung()` [update] — dashboard.js:4484 · `initSchnellerfassung()` [insert] — dashboard.js:18974 · `maybeOfferAppointmentConfirmEmail()` [update] — dashboard.js:7423 · `verordnungPatientenAbgleich()` [update] — module/verordnung-patient-abgleich.js:18

**Liest (37):** `altbestandAusLeads()`, `ausfallVereinbarungDatum()`, `downloadDmrzForInvoice()`, `fillRzPatientFromLead()`, `findeLeadIdZuTermin()`, `fmt()`, `handleSessionDrop()`, `handleTerminStarten()`, `initBkCustomerAutocomplete()`, `initBkGroupPatientAutocomplete()`, `initCalRightPanel()`, `initWlPatientAutocomplete()`, `ladeAktiveVerordnungen()`, `ladeKassen()`, `ladePatienten()`, `loadActivityFeed()`, `loadAnamnese()`, `loadB2C()`, `loadBkLeads()`, `loadInvPatients()` … +17
...
**Schreibt (2):** `refreshMessreihen()` [delete] — dashboard.js:8560 · `saveMessung()` [insert] — dashboard.js:8684
...
**Schreibt (3):** `behandlungenVerknuepfen()` [update] — module/rechnung-bruecke.js:180 · `loadPodologieBilling()` [insert] — module/podologie-abrechnung.js:397 · `verknuepfungLoesen()` [update] — module/rechnung-bruecke.js:197

**Liest (9):** `frag()`, `ladeAbrechnungAuswahl()`, `ladeAktiveVerordnungen()`, `ladeVerlauf()`, `offeneBehandlungen()`, `patientenBehandlungen()`, `podoHistorie()`, `podPatientBehandlungen()`, `verordnungenLaden()`

**Dateien:** `api-backend/billing/api/abrechnung.routes.js`, `api-backend/billing/api/verordnung-status.routes.js`, `module/abrechnung-auswahl.js`, `module/patientenkarte.js`, `module/podologie-abrechnung.js`, `module/rechnung-bruecke.js`, `module/rechnung-verordnung.js`, `module/termin-leistungen.js`, `module/verordnung-podo.js`, `module/verordnung-uebersicht.js`
...
**Schreibt (9):** `betragNullsetzen()` [update] — module/zuzahlung-befreiung.js:291 · `downloadDmrzForInvoice()` [update] — module/rechnung-dmrz.js:109 · `flipAbrechnungStatus()` [update] — dashboard.js:8415 · `kassiereZuzahlung()` [update] — dashboard.js:7093 · `pruefeVerordnungsfortschritt()` [update] — module/sitzungsfortschritt.js:106 · `speichereEinheiten()` [update] — module/verordnung-einheiten.js:126 · `storniereZuzahlung()` [update] — dashboard.js:7168 · `triggerStorno()` [update] — dashboard.js:18426 · `zaehler()` [update] — module/sitzungsfortschritt.js:109

**Liest (31):** `aufEuro()`, `frag()`, `frageZahlungsstatus()`, `initBkCustomerAutocomplete()`, `korrekturAusPanel()`, `ladeAbrechnungAuswahl()`, `ladeAktiveVerordnungen()`, `ladeVerlauf()`, `ladeZuweisungen()`, `linkBookingsToPrescriptionSessions()`, `loadAnamneseRxContext()`, `loadBkVerordnungen()`, `loadCalRpRezeptInfo()`, `loadPatientDetailRezepte()`, `loadPatRxTable()`, `loadPhysioRezKpis()`, `loadRxSessionsPanel()`, `loadUeberblickDeadlines()`, `oeffnePodoBehandlungen()`, `oeffneZuzahlungKorrektur()` … +11
...
**Schreibt (21):** `bindBilling()` [update] — onboarding.js:453 · `bindBusiness()` [update] — onboarding.js:388 · `bindHours()` [update] — onboarding.js:813 · `bindOwner()` [update] — onboarding.js:516 · `bindPlan()` [update] — onboarding.js:870 · `ensureBookingSlug()` [update] — dashboard.js:13420 · `ensureClinicLocation()` [update] — dashboard.js:5619 · `ensureCompanyCode()` [update] — dashboard.js:13403 · `fmt()` [update] — dashboard.js:10708 · `handleSave()` [update] — onboarding.js:457 · `init()` [update] — kalender.js:155 · `initAnfragenPanel()` [update] — dashboard.js:20822 · `loadProfile()` [insert] — onboarding.js:115 · `openEmpDetail()` [update] — dashboard.js:11040 · `openStripePortal()` [update] — dashboard.js:2328 · `renderLegendeSettings()` [update] — module/fussbefund.js:1633 · `saveAusfallSettings()` [update] — module/ausfall-einstellungen.js:76 · `saveEmployee()` [insert] — dashboard.js:13929 · `saveStepProgress()` [update] — onboarding.js:281 · `speichereKonten()` [update] — module/buchungskonten.js:295 · `speichereStufen()` [update] — module/selbstzahler-stufen.js:259
...
**Schreibt (8):** `autoSeedGkvServices()` [insert] — dashboard.js:9353 · `ensureBlankoBonusServices()` [insert/update] — dashboard.js:7520 · `ensureBlockerServices()` [insert/update] — module/kalender-blocker.js:71 · `migratePodologieLegacyServices()` [update] — dashboard.js:9549 · `normName()` [delete/insert/update] — onboarding.js:599 · `renderServices()` [delete] — dashboard.js:9736 · `syncServices()` [delete/insert/update] — onboarding.js:618 · `wireBusinessModal()` [insert] — dashboard.js:16529
...
**Schreibt (1):** `fmt()` [upsert] — dashboard.js:10708
...
**Schreibt (2):** `fmt()` [delete/insert] — dashboard.js:10708 · `loadEmpCertificates()` [delete/insert] — dashboard.js:11509
...
**Schreibt (6):** `deleteEmpTimeOff()` [delete] — dashboard.js:10644 · `deleteUrlaub()` [delete] — dashboard.js:10718 · `fmt()` [delete/insert] — dashboard.js:10708 · `loadTeam()` [insert] — dashboard.js:10378 · `openEmpDetail()` [insert] — dashboard.js:11040 · `saveUrlaub()` [insert] — dashboard.js:10660
...
**Schreibt (2):** `saveUserPref()` [upsert] — dashboard.js:14155 · `switchBusiness()` [upsert] — dashboard.js:16691
...
**Schreibt (3):** `loadFbVehicles()` [delete] — dashboard.js:18101 · `saveQuickVehicleHandler()` [insert] — dashboard.js:4120 · `saveVehicleEdit()` [insert/update] — dashboard.js:18204
...
**Schreibt (2):** `reportSidebarVisibility()` [upsert] — dashboard.js:949 · `saveVisToggle()` [delete] — admin.js:387
...
**Schreibt (1):** `initWlModal()` [delete/insert/update] — dashboard.js:19291
...
**Schreibt (3):** `bindHours()` [delete/insert] — onboarding.js:813 · `fmt()` [upsert] — dashboard.js:10708 · `loadEmpHours()` [upsert] — dashboard.js:11331
...
**Schreibt (2):** `oeffneBefreiungsFormular()` [delete/upsert] — module/zuzahlung-befreiung.js:62 · `wireBefreiungCard()` [delete] — dashboard.js:8487
