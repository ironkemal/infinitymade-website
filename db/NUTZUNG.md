...
**Schreibt (1):** `downloadAbrechnungFile()` [update] — dashboard.js:19978
...
**Schreibt (3):** `deleteAerzte()` [delete] — dashboard.js:16237 · `editAerzte()` [update] — dashboard.js:16246 · `resolveOrCreateArzt()` [insert/update] — api-backend/lib/arzt-registry.js:55
...
**Schreibt (1):** `saveAnamnese()` [insert/update] — dashboard.js:15837
...
**Schreibt (2):** `fmt()` [delete/insert/update] — dashboard.js:10846 · `renderB2B()` [delete] — dashboard.js:11728
...
**Schreibt (3):** `fmt()` [delete/insert] — dashboard.js:10846 · `loadEmpHours()` [delete/insert] — dashboard.js:11469 · `renderHoursGrid()` [delete/insert] — dashboard.js:10215
...
**Schreibt (5):** `bindBusiness()` [insert/update] — onboarding.js:388 · `deleteBusiness()` [delete] — dashboard.js:17396 · `ensureBusinessCoords()` [update] — dashboard.js:22766 · `toggleStandortDay()` [update] — dashboard.js:10191 · `wireBusinessModal()` [insert/update] — dashboard.js:17313
...
**Schreibt (3):** `fmt()` [delete] — dashboard.js:10846 · `loadIntegrations()` [delete] — kalender.js:746 · `loadSettings()` [delete] — dashboard.js:12282
...
**Schreibt (1):** `saveSpecialDays()` [upsert] — dashboard.js:10413
...
**Schreibt (1):** `saveDataSharing()` [upsert] — dashboard.js:17159
...
**Schreibt (10):** `_enterAnsichtEditMode()` [update] — dashboard.js:12931 · `commit()` [update] — dashboard.js:13163 · `deleteVorlage()` [delete] — dashboard.js:13131 · `duplicateVorlage()` [insert] — dashboard.js:13140 · `fmt()` [delete/insert/update] — dashboard.js:10846 · `openVorlagenAnsicht()` [update] — dashboard.js:12841 · `saveVorlage()` [insert/update] — dashboard.js:13101 · `seedDefaultVorlagen()` [insert] — dashboard.js:13199 · `seedMissingVorlagen()` [insert] — dashboard.js:13205 · `startVorlagenInlineRename()` [update] — dashboard.js:13156
...
**Schreibt (2):** `fmt()` [insert] — dashboard.js:10846 · `loadPatientDetailMails()` [update] — dashboard.js:8879
...
**Schreibt (4):** `fmt()` [delete/upsert] — dashboard.js:10846 · `renderEmpStandortList()` [delete/upsert] — dashboard.js:11024 · `renderOtherStandortEmps()` [upsert] — dashboard.js:10877 · `saveEmpPermissions()` [upsert] — dashboard.js:11125
...
**Schreibt (2):** `fmt()` [delete/insert] — dashboard.js:10846 · `saveEmpPermissions()` [delete/insert] — dashboard.js:11125
...
**Schreibt (4):** `fmt()` [delete/insert] — dashboard.js:10846 · `loadEmpServices()` [delete/insert] — dashboard.js:11561 · `normName()` [insert] — onboarding.js:599 · `syncServices()` [insert] — onboarding.js:618
...
**Schreibt (4):** `dialog()` [update] — module/rechnung-zahlung.js:129 · `frageZahlungsstatus()` [update] — module/rechnung-zahlung.js:68 · `markiereRechnungBezahlt()` [update] — module/rechnung-zahlung.js:49 · `saveInvoice()` [insert/update] — dashboard.js:15266
...
**Schreibt (2):** `refreshMessreihen()` [delete] — dashboard.js:8604 · `saveMessung()` [insert] — dashboard.js:8728
...
**Schreibt (3):** `behandlungenVerknuepfen()` [update] — module/rechnung-bruecke.js:165 · `loadPodologieBilling()` [insert] — module/podologie-abrechnung.js:514 · `verknuepfungLoesen()` [update] — module/rechnung-bruecke.js:182
...
**Schreibt (1):** `uploadRxNachweise()` [insert] — dashboard.js:18385
...
**Schreibt (1):** `fmt()` [insert] — dashboard.js:10846
...
**Schreibt (1):** `fmt()` [upsert] — dashboard.js:10846
...
**Schreibt (2):** `fmt()` [delete/insert] — dashboard.js:10846 · `loadEmpCertificates()` [delete/insert] — dashboard.js:11647
...
**Schreibt (6):** `deleteEmpTimeOff()` [delete] — dashboard.js:10782 · `deleteUrlaub()` [delete] — dashboard.js:10856 · `fmt()` [delete/insert] — dashboard.js:10846 · `loadTeam()` [insert] — dashboard.js:10516 · `openEmpDetail()` [insert] — dashboard.js:11178 · `saveUrlaub()` [insert] — dashboard.js:10798
...
**Schreibt (2):** `saveUserPref()` [upsert] — dashboard.js:14475 · `switchBusiness()` [upsert] — dashboard.js:17475
...
**Schreibt (1):** `initWlModal()` [delete/insert/update] — dashboard.js:21755
...
**Schreibt (3):** `bindHours()` [delete/insert] — onboarding.js:813 · `fmt()` [upsert] — dashboard.js:10846 · `loadEmpHours()` [upsert] — dashboard.js:11469
...
**Schreibt (3):** `oeffneBefreiungsFormular()` [delete/upsert] — module/zuzahlung-befreiung.js:62 · `uploadRxNachweise()` [insert/update] — dashboard.js:18385 · `wireBefreiungCard()` [delete] — dashboard.js:8531
