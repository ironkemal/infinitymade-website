...
- **`krankenkassen.ik_number` steht in `0009` in jeder Zeile absichtlich auf `NULL`** (Begründung
  ...
  es ist die sichere Richtung. **Ab `0040_krankenkassen_ik_nachtrag`** (⏳ vorbereitet, noch nicht
...
- **Seit:** 21.09.2026 · `api-backend/db/migrations/0039_kostentraeger_auswahl_view.sql` (Ops #300, Konsey `konsey/tutanak/2026-09-21-ik-suche-kassenfeld.md`)
...
- **Status:** aktiv (Referenz) — `ik_number` ist eine **Vorbelegung, nur wenn eindeutig**, keine Abrechnungswahrheit (Ops #301, Konsey 21.09.2026). Live 21.09.2026: 76 von 94 gefüllt, 18 NULL. Nach Migration `0040_krankenkassen_ik_nachtrag`: 74 gefüllt, 20 NULL — ⏳ **vorbereitet, noch nicht angewandt** (beim Anwenden diese Zeile auf ✅ mit Datum ändern).
