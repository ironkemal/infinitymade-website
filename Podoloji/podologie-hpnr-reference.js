...
export const DIAGNOSEGRUPPEN = {
  DF: {
    ...
    untergruppen: ['a', 'b', 'c'],
    icd10: ['E10.74', 'E10.75', 'E11.74', 'E11.75'],
...
export const HPNR_PODOLOGIE = {
  ...
  '78620': {
    hpnr: '78620',
    leistungsart: 'Nagelspange',
    leistung: 'Nagelkorrekturspange kontrollieren / nachjustieren',
    diagnosegruppen: ['UI2'],
    kombinierbar_mit_78030: false,
    lokalisation_pflicht: true,
    gueltig_ab: '2025-10-01',
    ...
    quelle: 'GKV-SV',
    aenderung: 'Neu aufgenommen 11.04.2025 (HPNR-Liste 2025/2026)',
    notiz: 'Folgetermine für Spange-Kontrolle/Nachjustierung.',
  },

  // Hausbesuch
  '78530': {
    hpnr: '78530',
    leistungsart: 'Hausbesuch-Zuschlag',
    leistung: 'Zuschlag für Behandlung im Hausbesuch',
    ...
    grundlage: '§125 Abs. 1 SGB V',
    quelle: 'GKV-SV',
    notiz: 'Nur abrechenbar wenn Hausbesuch auf HVO verordnet (Anlage 3, Feld Hausbesuch).',
  },
};
...
export const VERORDNUNG_REGELN = {
  ...
  optionale_felder: [
    { feld: 'hausbesuch', beschreibung: 'Wenn angekreuzt: 78530 abrechenbar' },
...
export const VALIDIERUNGS_REGELN = [
  ...
  },
  {
    ...
    beschreibung: '78530 nur wenn HVO Hausbesuch-Feld angekreuzt',
    quelle: 'Anlage 3, Feld Hausbesuch',
  },
];
