-- O-38 (onprem/REGISTER.md) — Referenzdaten für die Box: heilmittel_katalog
-- (search_heilmittel() RPC — TÜM Heilmittel seçicilerinin kaynağı; bu tablo
-- olmadan kutuda hiçbir Heilmittel seçilemez, krankenkassen → [] ile aynı ağırlıkta
-- bir boşluktu ve O-38'in orijinal 9-tablo listesinde HİÇ yoktu, onprem-review +
-- db-ustasi bu turda buldu).
--
-- Otorite zinciri değişmedi: bu tablo api-backend/sync_heilmittel_katalog.js ile
-- billing/codes/*.js'ten üretiliyor (kendi drift-testi var). Bu dosya o üretimin
-- ÇIKTISINI dump ediyor, ikinci bir üretim yolu AÇMIYOR.
--
-- ⚠️ Bilinen açık boşluk (SEED-11, yeni madde adayı): codes/*.js değişip
-- sync_heilmittel_katalog.js SaaS'ta elle koşturulduğunda, bu seed dosyası
-- otomatik güncellenmez — kutu bir sonraki fiyat değişikliğinde SaaS'tan
-- sessizce ayrışabilir. tools/check-onprem.sh'a bir kapı eklenmesi öneriliyor
-- (codes/*_positions.js değişirse aynı commit'te yeni seed migration'ı da gelsin).
...
INSERT INTO public.heilmittel_katalog (code, bereich, label, kuerzel, kategorie, diagnosegruppen, preis_eur, zuzahlung_eur, dauer, gueltig_ab, gueltig_bis, deprecated, ungueltig_ab, ersetzt_durch, max_pro_tag, max_pro_termin, notiz, gruppe, telemed, sort) VALUES
  ('21901','physiotherapy','Geburtsvorbereitung Gruppe',NULL,'Hebamme',NULL,'11.40',NULL,'60','1900-01-01','9999-12-31','f',NULL,NULL,NULL,NULL,NULL,'t','f','56'),
  ('21904','physiotherapy','Rückbildungsgymnastik Gruppe',NULL,'Hebamme',NULL,'11.40',NULL,'60','1900-01-01','9999-12-31','f',NULL,NULL,NULL,NULL,NULL,'t','f','57'),
  ...
  ('X0107','physiotherapy','Bindegewebsmassage (BGM)','BGM','Massage',NULL,'25.98','2.60','20-30','1900-01-01','9999-12-31','f',NULL,NULL,NULL,NULL,NULL,'f','f','2'),
  ...
  ('X0205','physiotherapy','MLD 30 Min (Teilbehandlung)','MLD','Lymphdrainage',NULL,'35.97','3.60','30','1900-01-01','9999-12-31','f',NULL,NULL,NULL,NULL,NULL,'f','f','7'),
  ...
  ('X0402','physiotherapy','Übungsbehandlung Bewegungsbad Gruppe (2-3)',NULL,'Übungsbehandlung',NULL,'24.00','2.40','20-30','1900-01-01','9999-12-31','f',NULL,NULL,NULL,NULL,NULL,'t','f','12'),
  ...
  ('X1005','physiotherapy','KG Bewegungsbad Gruppe (4-5)',NULL,'Krankengymnastik',NULL,'15.97','1.60','20-30','1900-01-01','9999-12-31','f',NULL,NULL,NULL,NULL,NULL,'t','f','31'),
  ...
  ('X1303','physiotherapy','Elektrostimulation bei Paresen',NULL,'Elektrotherapie',NULL,'18.70','1.87','5-10','1900-01-01','9999-12-31','f',NULL,NULL,NULL,NULL,NULL,'f','f','36'),
  ...
  ('X1534','physiotherapy','Kältetherapie','K','Kältetherapie',NULL,'11.95','1.20','5-10','1900-01-01','9999-12-31','f',NULL,NULL,NULL,NULL,NULL,'f','f','45'),
  ...
  ('X1732','physiotherapy','CO2-Trockenbad Voll-/Dreiviertel-/Halbbad',NULL,'Bäder',NULL,'26.30','2.63','10-20','1900-01-01','9999-12-31','f',NULL,NULL,NULL,NULL,NULL,'f','f','47'),
  ('X1733','physiotherapy','CO2-Trockenbad Teilbad',NULL,'Bäder',NULL,'26.30','2.63','45-60','1900-01-01','9999-12-31','f',NULL,NULL,NULL,NULL,NULL,'f','f','48'),
  ...
  ('X9701','physiotherapy','Übermittlungsgebühr Bericht',NULL,'Verwaltung',NULL,'1.40',NULL,NULL,'1900-01-01','9999-12-31','f',NULL,NULL,NULL,NULL,NULL,'f','f','52'),
  ...
  ('78010','podologie','Podologische Behandlung (klein)',NULL,NULL,'{DF,NF,QF}','36.10','3.61','35','2026-07-01','9999-12-31','f',NULL,NULL,NULL,NULL,NULL,'f','f','18'),
  ...
  ('78040','podologie','Eingangsbefundung',NULL,NULL,'{DF,NF,QF}','22.48','2.25','20','2025-07-01','2026-06-30','f',NULL,NULL,NULL,NULL,'Einmalig je Patient (Lebenszeit). Nicht am selben Tag wie 78030.','f','f','3'),
  ('78040','podologie','Eingangsbefundung',NULL,NULL,'{DF,NF,QF}','23.11','2.31','20','2026-07-01','9999-12-31','f',NULL,NULL,NULL,NULL,'Einmalig je Patient (Lebenszeit). Nicht am selben Tag wie 78030.','f','f','21'),
  ('78100','podologie','Erstbefundung groß',NULL,NULL,'{UI1,UI2}','56.00','5.60','45','2025-07-01','2026-06-30','f',NULL,NULL,NULL,NULL,'1x pro Kalenderjahr. Gilt auch bei Wiedervorstellung. Nachtestung nach Heilung möglich.','f','f','11'),
  ...
  ('78110','podologie','Erstbefundung klein',NULL,NULL,'{UI1,UI2}','27.90','2.79','20','2025-07-01','2026-06-30','f',NULL,NULL,NULL,NULL,NULL,'f','f','12'),
  ...
  ('78210','podologie','Anpassung Ross-Fraser-Spange (einteilig)',NULL,NULL,'{UI1,UI2}','99.04','9.90','90','2025-07-01','2025-09-30','t','2025-10-01','78610',NULL,NULL,NULL,'f','f','4'),
  ...
  ('78230','podologie','Nachregulierung Ross-Fraser-Spange',NULL,NULL,'{UI1,UI2}','50.95','5.10','45','2026-07-01','9999-12-31','t','2025-10-01',NULL,NULL,NULL,NULL,'f','f','24'),
  ...
  ('78300','podologie','Mehrteilige bilaterale Nagelkorrekturspange',NULL,NULL,'{UI1,UI2}','99.90','9.99','75','2026-07-01','9999-12-31','t','2025-10-01',NULL,NULL,NULL,NULL,'f','f','25'),
  ...
  ('78400','podologie','Einteilige Kunststoff-/Metall-Nagelkorrekturspange',NULL,NULL,'{UI1,UI2}','55.20','5.52','45','2026-07-01','9999-12-31','t','2025-10-01',NULL,NULL,NULL,NULL,'f','f','26'),
  ...
  ('78610','podologie','Nagelspangenbehandlung',NULL,NULL,'{UI1,UI2}','55.90','5.59','45','2025-10-01','2026-06-30','f',NULL,NULL,'2',NULL,'Ersetzt alle alten Nagelspange-Codes. Darf 2x je Tag abgegeben werden.','f','f','9'),
  ('78610','podologie','Nagelspangenbehandlung',NULL,NULL,'{UI1,UI2}','57.20','5.72','45','2026-07-01','9999-12-31','f',NULL,NULL,'2',NULL,NULL,'f','f','27'),
  ...
  ('79934','podologie','Hausbesuch in soz. Einrichtung, inkl. Wegegeld',NULL,NULL,'{DF,NF,QF,UI1,UI2}','13.60','1.36',NULL,'2025-07-01','2026-06-30','f',NULL,NULL,NULL,NULL,'Nur abrechenbar wenn Feld "Hausbesuch = Ja" auf Muster 13 angekreuzt.','f','f','17'),
...
ON CONFLICT (bereich, code, gueltig_ab) DO UPDATE SET
  label=EXCLUDED.label, kuerzel=EXCLUDED.kuerzel, kategorie=EXCLUDED.kategorie, diagnosegruppen=EXCLUDED.diagnosegruppen,
  preis_eur=EXCLUDED.preis_eur, zuzahlung_eur=EXCLUDED.zuzahlung_eur, dauer=EXCLUDED.dauer, gueltig_bis=EXCLUDED.gueltig_bis,
  deprecated=EXCLUDED.deprecated, ungueltig_ab=EXCLUDED.ungueltig_ab, ersetzt_durch=EXCLUDED.ersetzt_durch,
  max_pro_tag=EXCLUDED.max_pro_tag, max_pro_termin=EXCLUDED.max_pro_termin, notiz=EXCLUDED.notiz,
  gruppe=EXCLUDED.gruppe, telemed=EXCLUDED.telemed, sort=EXCLUDED.sort;
