...
export const REGEL_SCHWERE = Object.freeze({
  ...
  'F:03002': { schwere: 'hart', kasse: 'datei',
    quelle: 'Anlage 1 TP5 V21, Kap. 5.5.2 (SLGA REC, S. 34) + Kap. 5.5.3.1 (SLLA REC, S. 44): Sammel-Rechnungsnummer ..14 AN M; Notation Kap. 5.1 (8)',
    hinweis: 'Sammelrechnungsnummer > 14 Zeichen' },
  ...
  // F:03006 & F:03007 — neue HARTE Regeln vom 20.09.2026. Die nach REGELN.md § 3
  // Punkt 3 erforderliche Zustimmung von `gkv-302` liegt vor (Beleg dort, § 6).
  'F:03006': { schwere: 'hart', kasse: 'datei',
    quelle: 'Anlage 1 TP5 V21, Kap. 5.5.2 (SLGA REC, S. 34) + Kap. 5.5.3.1 (SLLA REC, S. 44): Sammel-Rechnungsnummer ..14 AN M; Notation Kap. 5.1 (8)',
    hinweis: 'Sammelrechnungsnummer enthält unzulässige Zeichen (nur A-Z a-z 0-9, Gliederung nur - und /)' },
  'F:03007': { schwere: 'hart', kasse: 'datei',
    quelle: 'Anlage 1 TP5 V21, Kap. 5.5.3.1 (SLLA REC, S. 44), Einzel-Rechnungsnummer ..6 AN M; Notation Kap. 5.1 (8)',
    hinweis: 'Einzelrechnungsnummer > 6 Zeichen' },
