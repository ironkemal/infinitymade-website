...
Tüm arşiv **05.09.2026'dan beri `wissensbank/` altında.** Bölme ölçütü: kaç Fachbereich'ı
ilgilendiriyor? Klasör kuralının tamamı `wissensbank/README.md`'de.

```
gemeinsam/302-tp5/                §302 teknik anlagen, Anhänge, XSD, değişiklik belgeleri
...
_archiv/                          düşmüş · kapsam dışı · mükerrer kopyalar
```

⚠️ **`Podoloji/` ile karıştırma.** O klasör hâlâ duruyor ama artık belge tutmuyor —
içinde yalnız **kendi ürettiğimiz** iş var (prototip, ürün kararı, loop promptu,
`podologie-hpnr-reference.js`). Resmî belge arıyorsan burası değil, `wissensbank/`.
...
Kapsam dışı bırakılanlar: `wissensbank/_archiv/Zusatzdateien/` altındaki klinik ölçek
...
### wissensbank/gemeinsam/302-tp5/Anlage_3_TP5_V22_20260218.txt
...
### wissensbank/gemeinsam/302-tp5/Anlage_3_TP5_V21_20250919.txt
- **Ne:** § 302 Abs. 2 SGB V uyarınca „Sonstigen Leistungserbringern“ ile Hebammen ve Entbindungspflegern (§ 301a SGB V) faturalandırma usulünün form ve içeriğine ilişkin rehberlerin anahtar dizinlerini (Schlüsselverzeichnisse) içeren Anlage 3 belgesidir.
...
### wissensbank/gemeinsam/302-tp5/Anhang_04c_Anlage_1_TP5_20250924_Verfahrensdokumentation-Erlaeuterungen_zum_Formular.txt
...
### wissensbank/gemeinsam/302-tp5/Anhang_04c_Anlage_1_TP5_20250924_Formular_Verfahrensbeschreibung_Image-Link-Verfahren (1).txt
...
### wissensbank/gemeinsam/302-tp5/Anlage_4_061101.txt
...
### wissensbank/gemeinsam/302-tp5/Aenderungshistorie.txt
...
### wissensbank/gemeinsam/302-tp5/0_Änderungen.txt
...
### wissensbank/physiotherapie/anlage2.txt
...
### wissensbank/gemeinsam/302-tp5/Richtlinien-Text_061120.txt
...
### wissensbank/gemeinsam/302-tp5/TP5_Infoschreiben_BAHN-BKK_wegen_Dienstleisterwechsel_zum_01.01.2026.txt
...
### wissensbank/gemeinsam/302-tp5/gkv-datenaustausch.de_media_dokumente_leistungserbringer_1_sonstige_leistungserbringer_technische_anlagen_aktuell_4_Anhang_04b_Anlage_1_TP5_20220519.xsd.txt
...
### wissensbank/gemeinsam/302-tp5/2024_09_01_Empfehlungen_zur_Umsetzung_der_Beschaeftigtennummer.txt
...
### wissensbank/physiotherapie/20251201_Physiotherapie_Vertrag_125_Anlage_2_barrierefrei.txt
...
### wissensbank/logopaedie/20260212_Vertrag_125_sssst_Anlage_2_Verguetungsvereinbarung.txt
...
### wissensbank/ergotherapie/20240531_Ergo_Anlage_2_Vertrag_nach_125_SGB_V_Verguetungsvereinbarung_BF.txt
...
### wissensbank/_archiv/20220421_Lesefassung_Anlage_3_Ernaehrungstherapie.txt
...
### wissensbank/podologie/20240725_Anlage_1a_Leistungsbeschreibung_lesefassung_b.txt
...
### wissensbank/podologie/20240725_Anlage_1b_Leistungsbeschreibung_Lesefassung_b.txt
...
### wissensbank/podologie/20250617_Podologie_Anlage_1c_Leistungsbeschreibung.txt
...
### wissensbank/podologie/20250617_Podologie_Anlage_2.txt
...
### wissensbank/podologie/20250617_Podologie_Anlage_3_Lesefassung.txt
...
### wissensbank/podologie/20250617_Podologie_Aenderungsvereinbarung.txt
...
### wissensbank/gemeinsam/positionsnummern/Positionsnummernverzeichnis_2026_Full.csv · wissensbank/podologie/Podologie_Positionsnummern_2026_Filtered.csv
...
- **Ne zaman lazım:** Bir HPNR'nin var olup olmadığını, tam Leistungsbezeichnung'unu ve geçerlilik tarihlerini doğrularken. Faturalanabilirlik için **ayrıca** `wissensbank/podologie/20250617_Podologie_Anlage_2.txt` kontrol edilir.
...
### wissensbank/gemeinsam/heilmittel-richtlinie/heilmittel-diagnoseliste.txt
...
### wissensbank/gemeinsam/heilmittel-richtlinie/praxiswissen-heilmittel.txt
...
### wissensbank/physiotherapie/NOVENTI-Leitfaden-Blankoverordnung-Physiotherapie.txt
...
### wissensbank/gemeinsam/icd-10-gm/icd10gm2026syst_metadaten_liesmich.txt
