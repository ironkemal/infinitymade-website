...
| **Durum** | 🔴 **offen** — 22.09.2026'da `0039` turunda bulundu. Not: `0039` bu hatayı tekrarlamıyor ama O-129'u da kapatmıyor — "✅ Im SaaS angewendet 22.09.2026 (MCP)" satırı **döküm künyesinde** ve `_hinweis_0039`'da var, **migration dosyasının kendi başlığında yok**. Kuralın istediği yer orası; geriye dönük düzeltme penceresi hâlâ açık (ilk kutu kurulmadı) |
