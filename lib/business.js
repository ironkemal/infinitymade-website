/**
 * InfinityMade — Business Context Helper
 * ======================================
...
/**
 * Kullanıcının erişimi olan tüm işletmeler.
 * RLS otomatik filtreler (owner kendi business'ları, employee bağlı olduğu owner'ın).
 */
