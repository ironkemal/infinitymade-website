/**
 * InfinityMade — Plan Gating Helper
 * =================================
...
/**
 * Kullanıcının verilen özelliğe erişimi var mı?
 *
 * Employee'ler için owner'ın planı geçerli (owner_id üzerinden çözülmesi gerek
 * — bu helper'a employee için owner profile'ı geçilmeli).
 */
