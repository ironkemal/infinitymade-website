...
// Supabase configuration — browser path uses supabase-config.js → /api/config
const SUPABASE_URL =
 ...
 * Uses the locally vendored bundle (vendor/supabase-js.js) — no external CDN.
 */
async function createBrowserClient() {
  const { createClient } = await import('../vendor/supabase-js.js?v=20260813');
