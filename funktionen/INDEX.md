...
- `openBookingActionModal()` — [dashboard.js:3241](dashboard.js#L3241-L3710) · 470 satır · bookings:update
...
- `handlePatientNichtErschienen()` — [dashboard.js:4513](dashboard.js#L4513-L4561) · 49 satır · bookings:update

**Yol 9 — `initBkGroupPatientAutocomplete()`** · Ekran: ortak yardımcı — 10 modülden çağrılıyor
- `loadGroupParticipants()` — [dashboard.js:4928](dashboard.js#L4928-L5006) · 79 satır · bookings:update
- `initBkGroupPatientAutocomplete()` — [dashboard.js:5044](dashboard.js#L5044-L5165) · 122 satır · bookings:insert

**Yol 10 — `doMoveBooking()`** · Ekran: ortak yardımcı — 10 modülden çağrılıyor
- `doMoveBooking()` — [dashboard.js:5507](dashboard.js#L5507-L5536) · 30 satır · bookings:update
...
- `downloadDmrzForInvoice()` — [dashboard.js:15601](dashboard.js#L15601-L15676) · 76 satır · prescriptions:update

**Yol 4 — `saveRezept()`** · Ekran: _UI yolu çözülemedi_
- `saveRezept()` — [dashboard.js:16975](dashboard.js#L16975-L17133) · 159 satır · prescriptions:insert
...
- `ensureClinicLocation()` — [dashboard.js:5830](dashboard.js#L5830-L5856) · 27 satır · profiles:update

**Yol 3 — `fmt()`** · Ekran: ortak yardımcı — 10 modülden çağrılıyor
- `fmt()` — [dashboard.js:11025](dashboard.js#L11025-L13556) · 2532 satır · profiles:update
- `openEmpDetail()` — [dashboard.js:11357](dashboard.js#L11357-L11554) · 198 satır · profiles:update

**Yol 4 — `bindPlan()`** · Ekran: _UI yolu çözülemedi_
- `ensureCompanyCode()` — [dashboard.js:13719](dashboard.js#L13719-L13725) · 7 satır · profiles:update
- `ensureBookingSlug()` — [dashboard.js:13736](dashboard.js#L13736-L13749) · 14 satır · profiles:update
...
- `saveEmployee()` — [dashboard.js:14428](dashboard.js#L14428-L14491) · 64 satır · profiles:insert

**Yol 6 — `saveAusfallSettings()`** · Ekran: _UI yolu çözülemedi_
- `saveAusfallSettings()` — [dashboard.js:17265](dashboard.js#L17265-L17307) · 43 satır · profiles:update

**Yol 7 — `initAnfragenPanel()`** · Ekran: ortak yardımcı — 11 modülden çağrılıyor
- `initAnfragenPanel()` — [dashboard.js:23450](dashboard.js#L23450-L23507) · 58 satır · profiles:update
...
- `autoSeedGkvServices()` — [dashboard.js:9668](dashboard.js#L9668-L9695) · 28 satır · services:insert
...
- `migratePodologieLegacyServices()` — [dashboard.js:9864](dashboard.js#L9864-L9899) · 36 satır · services:update

**Yol 4 — `renderServices()`** · Ekran: ortak yardımcı — 10 modülden çağrılıyor
- `renderServices()` — [dashboard.js:10051](dashboard.js#L10051-L10075) · 25 satır · services:delete

**Yol 5 — `wireBusinessModal()`** · Ekran: _UI yolu çözülemedi_
- `wireBusinessModal()` — [dashboard.js:17497](dashboard.js#L17497-L17578) · 82 satır · services:insert
...
- `toggleStandortDay()` — [dashboard.js:10370](dashboard.js#L10370-L10390) · 21 satır · businesses:update

**Yol 2 — `wireBusinessModal()`** · Ekran: _UI yolu çözülemedi_
- `wireBusinessModal()` — [dashboard.js:17497](dashboard.js#L17497-L17578) · 82 satır · businesses:update, businesses:insert

**Yol 3 — `deleteBusiness()`** · Ekran: _UI yolu çözülemedi_
- `deleteBusiness()` — [dashboard.js:17580](dashboard.js#L17580-L17597) · 18 satır · businesses:delete

**Yol 4 — `ensureBusinessCoords()`** · Ekran: ortak yardımcı — 10 modülden çağrılıyor
- `ensureBusinessCoords()` — [dashboard.js:22938](dashboard.js#L22938-L22967) · 30 satır · businesses:update
...
- `saveRezept()` — [dashboard.js:16975](dashboard.js#L16975-L17133) · 159 satır · leads:update
...
- `handlePatientNichtErschienen()` — [dashboard.js:4513](dashboard.js#L4513-L4561) · 49 satır · prescription_sessions:update
...
- `deleteAerzte()` — [dashboard.js:16416](dashboard.js#L16416-L16423) · 8 satır · aerzte:delete

**Yol 3 — `editAerzte()`** · Ekran: _UI yolu çözülemedi_
- `editAerzte()` — [dashboard.js:16425](dashboard.js#L16425-L16470) · 46 satır · aerzte:update
...
- `toLocal()` — [dashboard.js:20606](dashboard.js#L20606-L20669) · 64 satır · fahrten:update, fahrten:delete
...
- `renderHoursGrid()` — [dashboard.js:10394](dashboard.js#L10394-L10467) · 74 satır · breaks:insert, breaks:delete

**Yol 2 — `fmt()`** · Ekran: ortak yardımcı — 10 modülden çağrılıyor
- `fmt()` — [dashboard.js:11025](dashboard.js#L11025-L13556) · 2532 satır · breaks:insert, breaks:delete
- `loadEmpHours()` — [dashboard.js:11648](dashboard.js#L11648-L11738) · 91 satır · breaks:insert, breaks:delete

### `calendar_integrations` — 2 bağımsız yazma yolu

**Yol 1 — `fmt()`** · Ekran: ortak yardımcı — 10 modülden çağrılıyor
- `fmt()` — [dashboard.js:11025](dashboard.js#L11025-L13556) · 2532 satır · calendar_integrations:delete
- `loadSettings()` — [dashboard.js:12461](dashboard.js#L12461-L12577) · 117 satır · calendar_integrations:delete
...
**Yol 2 — `fmt()`** · Ekran: ortak yardımcı — 10 modülden çağrılıyor
- `fmt()` — [dashboard.js:11025](dashboard.js#L11025-L13556) · 2532 satır · email_logs:insert

### `employee_services` — 2 bağımsız yazma yolu

**Yol 1 — `fmt()`** · Ekran: ortak yardımcı — 10 modülden çağrılıyor
- `fmt()` — [dashboard.js:11025](dashboard.js#L11025-L13556) · 2532 satır · employee_services:insert, employee_services:delete
- `loadEmpServices()` — [dashboard.js:11740](dashboard.js#L11740-L11824) · 85 satır · employee_services:insert, employee_services:delete
...
**Yol 1 — `fmt()`** · Ekran: ortak yardımcı — 10 modülden çağrılıyor
- `loadTeam()` — [dashboard.js:10695](dashboard.js#L10695-L10890) · 196 satır · time_offs:insert
- `deleteEmpTimeOff()` — [dashboard.js:10961](dashboard.js#L10961-L10975) · 15 satır · time_offs:delete
- `fmt()` — [dashboard.js:11025](dashboard.js#L11025-L13556) · 2532 satır · time_offs:delete, time_offs:insert
- `deleteUrlaub()` — [dashboard.js:11035](dashboard.js#L11035-L11042) · 8 satır · time_offs:delete
- `openEmpDetail()` — [dashboard.js:11357](dashboard.js#L11357-L11554) · 198 satır · time_offs:insert

**Yol 2 — `saveUrlaub()`** · Ekran: _UI yolu çözülemedi_
- `saveUrlaub()` — [dashboard.js:10977](dashboard.js#L10977-L11004) · 28 satır · time_offs:insert

### `user_preferences` — 2 bağımsız yazma yolu

**Yol 1 — `saveUserPref()`** · Ekran: ortak yardımcı — 10 modülden çağrılıyor
- `saveUserPref()` — [dashboard.js:14654](dashboard.js#L14654-L14664) · 11 satır · user_preferences:upsert

**Yol 2 — `switchBusiness()`** · Ekran: _UI yolu çözülemedi_
- `switchBusiness()` — [dashboard.js:17659](dashboard.js#L17659-L17674) · 16 satır · user_preferences:upsert
...
**Yol 1 — `fmt()`** · Ekran: ortak yardımcı — 10 modülden çağrılıyor
- `fmt()` — [dashboard.js:11025](dashboard.js#L11025-L13556) · 2532 satır · working_hours:upsert
- `loadEmpHours()` — [dashboard.js:11648](dashboard.js#L11648-L11738) · 91 satır · working_hours:upsert
...
- `uploadRxNachweise()` — [dashboard.js:18568](dashboard.js#L18568-L18654) · 87 satır · zuzahlung_befreiung:update, zuzahlung_befreiung:insert
...
- `fmt` — dashboard.js:3849 · dashboard.js:8681 · dashboard.js:10658 · dashboard.js:10947 · dashboard.js:11025 · dashboard.js:14742 · dashboard.js:15149 · dashboard.js:22522 · dashboard.js:22608 · dashboard.js:22686 · dashboard.js:22718 · dashboard.js:22778 · module/kalender-raster.js:71 · module/rezeptinfo-geld.js:68
...
- `fmtEur` — api-backend/billing/pdf/ausfallrechnung.template.js:15 · api-backend/billing/pdf/begleitzettel.template.js:12 · api-backend/billing/pdf/mahnung.template.js:5 · api-backend/billing/pdf/rechnung.template.js:10 · api-backend/billing/pdf/rzg-quittung.template.js:10 · api-backend/billing/pdf/zuzahlungsrechnung.template.js:13 · dashboard.js:19282 · dashboard.js:21190 · dashboard.js:21331 · dashboard.js:21409
- `render` — calendar-widget.js:127 · dashboard.js:14102 · dashboard.js:22338 · ops/board.js:206 · ops/decisions.js:14 · ops/files.js:52 · ops/finance.js:959 · ops/meetings.js:23 · ops/wissen.js:66 · patient-suche.js:110
...
- `init` — attendance.js:297 · booking-request.js:1216 · booking.js:58 · cookie-consent.js:139 · dashboard.js:17722 · kalender.js:141 · onboarding.js:77
...
- `cleanup` — dashboard.js:7103 · dashboard.js:7132 · dashboard.js:7208 · dashboard.js:7312 · dashboard.js:23111
- `g` — dashboard.js:16483 · dashboard.js:16496 · dashboard.js:16820 · dashboard.js:16886 · module/termin-aktionen.js:347
...
- `closeModal` — dashboard.js:1291 · dashboard.js:12638 · dashboard.js:13057 · ops/app.js:162
...
- `v` — dashboard.js:13562 · dashboard.js:13587 · dashboard.js:13607 · dashboard.js:17508
...
- `loadTeam` — booking-request.js:513 · dashboard.js:10695 · kalender.js:195
- `initCalendar` — booking-request.js:562 · dashboard.js:2537 · kalender.js:245
- `norm` — dashboard.js:17888 · module/arzt-register.js:470 · ops/tools/regroup.mjs:59
