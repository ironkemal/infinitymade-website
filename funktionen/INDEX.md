...
**2191 fonksiyon** · 236 dosya · 39 sidebar modülü
...
- `openBookingActionModal()` — [dashboard.js:3237](dashboard.js#L3237-L3713) · 477 satır · bookings:update

**Yol 4 — `handleSessionDrop()`** · Ekran: ortak yardımcı — 9 modülden çağrılıyor
- `handleSessionDrop()` — [dashboard.js:3921](dashboard.js#L3921-L4017) · 97 satır · bookings:insert

**Yol 5 — `saveFahrtStartHandler()`** · Ekran: _UI yolu çözülemedi_
- `saveFahrtStartHandler()` — [dashboard.js:4201](dashboard.js#L4201-L4267) · 67 satır · bookings:update

**Yol 6 — `markArrivedHandler()`** · Ekran: _UI yolu çözülemedi_
- `markArrivedHandler()` — [dashboard.js:4284](dashboard.js#L4284-L4298) · 15 satır · bookings:update

**Yol 7 — `saveFahrtEndHandler()`** · Ekran: _UI yolu çözülemedi_
- `saveFahrtEndHandler()` — [dashboard.js:4328](dashboard.js#L4328-L4420) · 93 satır · bookings:update

**Yol 8 — `handleTerminStarten()`** · Ekran: _UI yolu çözülemedi_
- `handleTerminStarten()` — [dashboard.js:4422](dashboard.js#L4422-L4490) · 69 satır · bookings:update

**Yol 9 — `korrigiereNoShow()`** · Ekran: _UI yolu çözülemedi_
- `handlePatientNichtErschienen()` — [dashboard.js:4512](dashboard.js#L4512-L4550) · 39 satır · bookings:update
...
- `loadGroupParticipants()` — [dashboard.js:4803](dashboard.js#L4803-L4881) · 79 satır · bookings:update
- `initBkGroupPatientAutocomplete()` — [dashboard.js:4919](dashboard.js#L4919-L5040) · 122 satır · bookings:insert

**Yol 11 — `doMoveBooking()`** · Ekran: ortak yardımcı — 9 modülden çağrılıyor
- `doMoveBooking()` — [dashboard.js:5386](dashboard.js#L5386-L5415) · 30 satır · bookings:update
...
- `ensureClinicLocation()` — [dashboard.js:5688](dashboard.js#L5688-L5714) · 27 satır · profiles:update

**Yol 3 — `fmt()`** · Ekran: ortak yardımcı — 9 modülden çağrılıyor
- `fmt()` — [dashboard.js:10804](dashboard.js#L10804-L13805) · 3002 satır · profiles:update
- `openEmpDetail()` — [dashboard.js:11136](dashboard.js#L11136-L11333) · 198 satır · profiles:update
- `ensureCompanyCode()` — [dashboard.js:13498](dashboard.js#L13498-L13504) · 7 satır · profiles:update
- `ensureBookingSlug()` — [dashboard.js:13515](dashboard.js#L13515-L13528) · 14 satır · profiles:update
...
- `saveEmployee()` — [dashboard.js:14207](dashboard.js#L14207-L14270) · 64 satır · profiles:insert

**Yol 5 — `initAnfragenPanel()`** · Ekran: ortak yardımcı — 10 modülden çağrılıyor
- `initAnfragenPanel()` — [dashboard.js:21223](dashboard.js#L21223-L21280) · 58 satır · profiles:update
...
- `kassiereZuzahlung()` — [dashboard.js:7140](dashboard.js#L7140-L7212) · 73 satır · prescriptions:update
- `flipAbrechnungStatus()` — [dashboard.js:8452](dashboard.js#L8452-L8488) · 37 satır · prescriptions:update

**Yol 2 — `storniereZuzahlung()`** · Ekran: _UI yolu çözülemedi_
- `storniereZuzahlung()` — [dashboard.js:7215](dashboard.js#L7215-L7283) · 69 satır · prescriptions:update

**Yol 3 — `triggerStorno()`** · Ekran: ortak yardımcı — 10 modülden çağrılıyor
- `triggerStorno()` — [dashboard.js:18788](dashboard.js#L18788-L18847) · 60 satır · prescriptions:update
...
**Yol 6 — `speichereEinheiten()`** · Ekran: ortak yardımcı — 9 modülden çağrılıyor
...
**Yol 7 — `betragNullsetzen()`** · Ekran: ortak yardımcı — 9 modülden çağrılıyor
...
- `ensureBlankoBonusServices()` — [dashboard.js:7567](dashboard.js#L7567-L7606) · 40 satır · services:update, services:insert

**Yol 2 — `normName()`** · Ekran: _UI yolu çözülemedi_
- `autoSeedGkvServices()` — [dashboard.js:9449](dashboard.js#L9449-L9476) · 28 satır · services:insert
...
- `migratePodologieLegacyServices()` — [dashboard.js:9645](dashboard.js#L9645-L9680) · 36 satır · services:update

**Yol 4 — `renderServices()`** · Ekran: ortak yardımcı — 9 modülden çağrılıyor
- `renderServices()` — [dashboard.js:9832](dashboard.js#L9832-L9856) · 25 satır · services:delete

**Yol 5 — `wireBusinessModal()`** · Ekran: _UI yolu çözülemedi_
- `wireBusinessModal()` — [dashboard.js:16810](dashboard.js#L16810-L16891) · 82 satır · services:insert
...
- `toggleStandortDay()` — [dashboard.js:10149](dashboard.js#L10149-L10169) · 21 satır · businesses:update

**Yol 2 — `wireBusinessModal()`** · Ekran: _UI yolu çözülemedi_
- `wireBusinessModal()` — [dashboard.js:16810](dashboard.js#L16810-L16891) · 82 satır · businesses:update, businesses:insert

**Yol 3 — `deleteBusiness()`** · Ekran: _UI yolu çözülemedi_
- `deleteBusiness()` — [dashboard.js:16893](dashboard.js#L16893-L16910) · 18 satır · businesses:delete

**Yol 4 — `ensureBusinessCoords()`** · Ekran: ortak yardımcı — 9 modülden çağrılıyor
- `ensureBusinessCoords()` — [dashboard.js:20711](dashboard.js#L20711-L20740) · 30 satır · businesses:update
...
- `maybeOfferAppointmentConfirmEmail()` — [dashboard.js:7470](dashboard.js#L7470-L7557) · 88 satır · leads:update

**Yol 3 — `initSchnellerfassung()`** · Ekran: _UI yolu çözülemedi_
- `initSchnellerfassung()` — [dashboard.js:19363](dashboard.js#L19363-L19486) · 124 satır · leads:insert
...
- `handleSessionDrop()` — [dashboard.js:3921](dashboard.js#L3921-L4017) · 97 satır · prescription_sessions:update

**Yol 2 — `korrigiereNoShow()`** · Ekran: _UI yolu çözülemedi_
- `handlePatientNichtErschienen()` — [dashboard.js:4512](dashboard.js#L4512-L4550) · 39 satır · prescription_sessions:update
...
- `markPrescriptionSession()` — [dashboard.js:7345](dashboard.js#L7345-L7363) · 19 satır · prescription_sessions:update

**Yol 4 — `linkBookingsToPrescriptionSessions()`** · Ekran: _UI yolu çözülemedi_
- `linkBookingsToPrescriptionSessions()` — [dashboard.js:7378](dashboard.js#L7378-L7468) · 91 satır · prescription_sessions:update, prescription_sessions:insert
...
- `deleteAerzte()` — [dashboard.js:15834](dashboard.js#L15834-L15841) · 8 satır · aerzte:delete

**Yol 3 — `editAerzte()`** · Ekran: _UI yolu çözülemedi_
- `editAerzte()` — [dashboard.js:15843](dashboard.js#L15843-L15888) · 46 satır · aerzte:update

### `fahrten` — 3 bağımsız yazma yolu

**Yol 1 — `saveFahrtStartHandler()`** · Ekran: _UI yolu çözülemedi_
- `saveFahrtStartHandler()` — [dashboard.js:4201](dashboard.js#L4201-L4267) · 67 satır · fahrten:upsert

**Yol 2 — `saveFahrtEndHandler()`** · Ekran: _UI yolu çözülemedi_
- `saveFahrtEndHandler()` — [dashboard.js:4328](dashboard.js#L4328-L4420) · 93 satır · fahrten:upsert

**Yol 3 — `toLocal()`** · Ekran: ortak yardımcı — 10 modülden çağrılıyor
- `toLocal()` — [dashboard.js:18364](dashboard.js#L18364-L18427) · 64 satır · fahrten:update, fahrten:delete
...
- `renderHoursGrid()` — [dashboard.js:10173](dashboard.js#L10173-L10246) · 74 satır · breaks:insert, breaks:delete

**Yol 2 — `fmt()`** · Ekran: ortak yardımcı — 9 modülden çağrılıyor
- `fmt()` — [dashboard.js:10804](dashboard.js#L10804-L13805) · 3002 satır · breaks:insert, breaks:delete
- `loadEmpHours()` — [dashboard.js:11427](dashboard.js#L11427-L11517) · 91 satır · breaks:insert, breaks:delete

### `calendar_integrations` — 2 bağımsız yazma yolu

**Yol 1 — `fmt()`** · Ekran: ortak yardımcı — 9 modülden çağrılıyor
- `fmt()` — [dashboard.js:10804](dashboard.js#L10804-L13805) · 3002 satır · calendar_integrations:delete
- `loadSettings()` — [dashboard.js:12240](dashboard.js#L12240-L12356) · 117 satır · calendar_integrations:delete
...
- `loadPatientDetailMails()` — [dashboard.js:8873](dashboard.js#L8873-L8909) · 37 satır · email_logs:update

**Yol 2 — `fmt()`** · Ekran: ortak yardımcı — 9 modülden çağrılıyor
- `fmt()` — [dashboard.js:10804](dashboard.js#L10804-L13805) · 3002 satır · email_logs:insert

### `employee_services` — 2 bağımsız yazma yolu

**Yol 1 — `fmt()`** · Ekran: ortak yardımcı — 9 modülden çağrılıyor
- `fmt()` — [dashboard.js:10804](dashboard.js#L10804-L13805) · 3002 satır · employee_services:insert, employee_services:delete
- `loadEmpServices()` — [dashboard.js:11519](dashboard.js#L11519-L11603) · 85 satır · employee_services:insert, employee_services:delete
...
- `saveInvoice()` — [dashboard.js:14998](dashboard.js#L14998-L15092) · 95 satır · invoices:update, invoices:insert
...
**Yol 1 — `fmt()`** · Ekran: ortak yardımcı — 9 modülden çağrılıyor
- `loadTeam()` — [dashboard.js:10474](dashboard.js#L10474-L10669) · 196 satır · time_offs:insert
- `deleteEmpTimeOff()` — [dashboard.js:10740](dashboard.js#L10740-L10754) · 15 satır · time_offs:delete
- `fmt()` — [dashboard.js:10804](dashboard.js#L10804-L13805) · 3002 satır · time_offs:delete, time_offs:insert
- `deleteUrlaub()` — [dashboard.js:10814](dashboard.js#L10814-L10821) · 8 satır · time_offs:delete
- `openEmpDetail()` — [dashboard.js:11136](dashboard.js#L11136-L11333) · 198 satır · time_offs:insert

**Yol 2 — `saveUrlaub()`** · Ekran: _UI yolu çözülemedi_
- `saveUrlaub()` — [dashboard.js:10756](dashboard.js#L10756-L10783) · 28 satır · time_offs:insert

### `user_preferences` — 2 bağımsız yazma yolu

**Yol 1 — `saveUserPref()`** · Ekran: ortak yardımcı — 9 modülden çağrılıyor
- `saveUserPref()` — [dashboard.js:14433](dashboard.js#L14433-L14443) · 11 satır · user_preferences:upsert

**Yol 2 — `switchBusiness()`** · Ekran: _UI yolu çözülemedi_
- `switchBusiness()` — [dashboard.js:16972](dashboard.js#L16972-L16987) · 16 satır · user_preferences:upsert

### `vehicles` — 2 bağımsız yazma yolu

**Yol 1 — `saveQuickVehicleHandler()`** · Ekran: _UI yolu çözülemedi_
- `saveQuickVehicleHandler()` — [dashboard.js:4178](dashboard.js#L4178-L4199) · 22 satır · vehicles:insert

**Yol 2 — `loadFbVehicles()`** · Ekran: ortak yardımcı — 10 modülden çağrılıyor
- `loadFbVehicles()` — [dashboard.js:18463](dashboard.js#L18463-L18524) · 62 satır · vehicles:delete
- `saveVehicleEdit()` — [dashboard.js:18566](dashboard.js#L18566-L18598) · 33 satır · vehicles:update, vehicles:insert
...
**Yol 1 — `fmt()`** · Ekran: ortak yardımcı — 9 modülden çağrılıyor
- `fmt()` — [dashboard.js:10804](dashboard.js#L10804-L13805) · 3002 satır · working_hours:upsert
- `loadEmpHours()` — [dashboard.js:11427](dashboard.js#L11427-L11517) · 91 satır · working_hours:upsert
...
- `esc` — api-backend/billing/pdf/mahnung.template.js:4 · arzt-suche.js:34 · katalog-suche.js:86 · katalog-suche.js:98 · module/abrechnung-auswahl.js:420 · module/abrechnung-detail.js:107 · module/abrechnung-freigabe.js:112 · module/arzt-register.js:125 · module/krankenkasse-suche.js:173 · module/patienten-einwilligung.js:58 · module/patientenkarte.js:43 · module/rechnung-zahlungseingang.js:164 · module/verordnung-feldmarker.js:70 · module/verordnung-uebersicht.js:112 · module/zuzahlung-befreiung.js:261 · module/zuzahlung-korrektur.js:60 · ops/app.js:51
- `fmt` — dashboard.js:3848 · dashboard.js:8497 · dashboard.js:10437 · dashboard.js:10726 · dashboard.js:10804 · dashboard.js:14521 · dashboard.js:20275 · dashboard.js:20361 · dashboard.js:20439 · dashboard.js:20471 · dashboard.js:20531 · module/kalender-raster.js:71 · module/rechnung-ansicht.js:175 · module/rezeptinfo-geld.js:68
- `r2` — api-backend/billing/api/abrechnung.routes.js:1291 · api-backend/billing/api/statistik.routes.js:176 · api-backend/billing/api/zuzahlung.routes.js:45 · api-backend/billing/dta/builder.js:55 · api-backend/billing/preise/resolver.js:24 · api-backend/billing/utils/abrechnung-zeilen.js:36 · api-backend/billing/zuzahlung/calculator.js:14 · api-backend/billing/zuzahlung/korrektur.js:16 · module/abrechnung-verlauf.js:125 · module/zuzahlung-rechnen.js:42
...
- `render` — calendar-widget.js:127 · dashboard.js:13881 · dashboard.js:20091 · ops/board.js:206 · ops/decisions.js:14 · ops/files.js:52 · ops/finance.js:959 · ops/meetings.js:23 · ops/wissen.js:66 · patient-suche.js:116
...
- `g` — dashboard.js:15901 · dashboard.js:15914 · dashboard.js:16211 · dashboard.js:16282 · module/rezept-in-maske.js:39 · module/verordnung-anlegen.js:28 · module/verordnung-maske.js:324 · module/verordnung-nachweis.js:28
- `addDays` — api-backend/ai/validators/blankoRules.js:29 · api-backend/ai/validators/lhbBvbRules.js:24 · api-backend/ai/validators/standardRules.js:42 · api-backend/billing/api/mahnwesen.routes.js:45 · api-backend/server.js:259 · api-backend/server.js:1289 · dashboard.js:3178
...
- `init` — attendance.js:297 · booking-request.js:1242 · booking.js:58 · cookie-consent.js:139 · dashboard.js:17035 · kalender.js:149 · onboarding.js:77
...
- `cleanup` — dashboard.js:6977 · dashboard.js:7006 · dashboard.js:7109 · dashboard.js:20884 · module/absagegrund-modal.js:81
...
- `loadServices` — booking-request.js:419 · booking.js:193 · dashboard.js:9428 · kalender.js:635
- `speichern` — cookie-consent.js:69 · module/arzt-register.js:292 · module/fussbefund.js:679 · module/verordnung-detail.js:800
- `closeModal` — dashboard.js:1292 · dashboard.js:12417 · dashboard.js:12836 · ops/app.js:162
- `onEsc` — dashboard.js:7116 · module/rechnung-leistung-picker.js:46 · module/zuzahlung-befreiung.js:155 · module/zuzahlung-korrektur.js:214
- `v` — dashboard.js:13341 · dashboard.js:13366 · dashboard.js:13386 · dashboard.js:16821
...
- `loadTeam` — booking-request.js:513 · dashboard.js:10474 · kalender.js:238
- `initCalendar` — booking-request.js:562 · dashboard.js:2540 · kalender.js:288
- `zeileHtml` — module/abrechnung-detail.js:256 · module/fussbefund.js:1586 · module/verordnung-liste.js:149
