...
> Üretim: 2026-08-26 · `node tools/funktionskarte.mjs`
> **Elle düzenleme.** Script üretir; fonksiyon eklendiğinde "harita güncelle" ile tazelenir.

**1680 fonksiyon** · 154 dosya · 39 sidebar modülü
...
- `handleSessionDrop()` — [dashboard.js:3994](dashboard.js#L3994-L4090) · 97 satır · bookings:insert

**Yol 2 — `saveFahrtStartHandler()`** · Ekran: _UI yolu çözülemedi_
- `saveFahrtStartHandler()` — [dashboard.js:4274](dashboard.js#L4274-L4340) · 67 satır · bookings:update

**Yol 3 — `markArrivedHandler()`** · Ekran: _UI yolu çözülemedi_
- `markArrivedHandler()` — [dashboard.js:4357](dashboard.js#L4357-L4371) · 15 satır · bookings:update

**Yol 4 — `saveFahrtEndHandler()`** · Ekran: _UI yolu çözülemedi_
- `saveFahrtEndHandler()` — [dashboard.js:4401](dashboard.js#L4401-L4493) · 93 satır · bookings:update

**Yol 5 — `handleTerminStarten()`** · Ekran: _UI yolu çözülemedi_
- `handleTerminStarten()` — [dashboard.js:4495](dashboard.js#L4495-L4563) · 69 satır · bookings:update

**Yol 6 — `handlePatientNichtErschienen()`** · Ekran: _UI yolu çözülemedi_
- `handlePatientNichtErschienen()` — [dashboard.js:4585](dashboard.js#L4585-L4633) · 49 satır · bookings:update

**Yol 7 — `initBkGroupPatientAutocomplete()`** · Ekran: Sidebar → §302-Abrechnung (physiotherapy/praxis) · Sidebar → Patienten · Sidebar → Team
- `loadGroupParticipants()` — [dashboard.js:4998](dashboard.js#L4998-L5062) · 65 satır · bookings:update
- `initBkGroupPatientAutocomplete()` — [dashboard.js:5100](dashboard.js#L5100-L5221) · 122 satır · bookings:insert

**Yol 8 — `doMoveBooking()`** · Ekran: Sidebar → §302-Abrechnung (physiotherapy/praxis) · Sidebar → Patienten · Sidebar → Team
- `doMoveBooking()` — [dashboard.js:5557](dashboard.js#L5557-L5586) · 30 satır · bookings:update
...
- `flipAbrechnungStatus()` — [dashboard.js:8667](dashboard.js#L8667-L8703) · 37 satır · prescriptions:update

**Yol 2 — `downloadDmrzForInvoice()`** · Ekran: _UI yolu çözülemedi_
- `downloadDmrzForInvoice()` — [dashboard.js:16136](dashboard.js#L16136-L16211) · 76 satır · prescriptions:update

**Yol 3 — `saveRezept()`** · Ekran: _UI yolu çözülemedi_
- `saveRezept()` — [dashboard.js:17521](dashboard.js#L17521-L17679) · 159 satır · prescriptions:insert

**Yol 4 — `renderAbrechnungReady()`** · Ekran: Sidebar → §302-Abrechnung (physiotherapy/praxis) · Sidebar → Patienten · Sidebar → Team
- `renderAbrechnungReady()` — [dashboard.js:20249](dashboard.js#L20249-L20480) · 232 satır · prescriptions:update

**Yol 5 — `renderAbrechnungHistory()`** · Ekran: Sidebar → §302-Abrechnung (physiotherapy/praxis) · Sidebar → Patienten · Sidebar → Team
- `renderAbrechnungHistory()` — [dashboard.js:20482](dashboard.js#L20482-L20569) · 88 satır · prescriptions:update
...
- `triggerStorno()` — [dashboard.js:21586](dashboard.js#L21586-L21645) · 60 satır · prescriptions:update
...
- `openStripePortal()` — [dashboard.js:2258](dashboard.js#L2258-L2368) · 111 satır · profiles:update

**Yol 2 — `ensureClinicLocation()`** · Ekran: _UI yolu çözülemedi_
- `ensureClinicLocation()` — [dashboard.js:5880](dashboard.js#L5880-L5906) · 27 satır · profiles:update

**Yol 3 — `openEmpDetail()`** · Ekran: Sidebar → §302-Abrechnung (physiotherapy/praxis) · Sidebar → Patienten · Sidebar → Team
- `openEmpDetail()` — [dashboard.js:11893](dashboard.js#L11893-L12090) · 198 satır · profiles:update

**Yol 4 — `bindPlan()`** · Ekran: _UI yolu çözülemedi_
- `ensureCompanyCode()` — [dashboard.js:14254](dashboard.js#L14254-L14260) · 7 satır · profiles:update
- `ensureBookingSlug()` — [dashboard.js:14271](dashboard.js#L14271-L14284) · 14 satır · profiles:update
...
- `saveEmployee()` — [dashboard.js:14963](dashboard.js#L14963-L15026) · 64 satır · profiles:insert

**Yol 6 — `saveAusfallSettings()`** · Ekran: _UI yolu çözülemedi_
- `saveAusfallSettings()` — [dashboard.js:17811](dashboard.js#L17811-L17853) · 43 satır · profiles:update
...
- `initAnfragenPanel()` — [dashboard.js:25313](dashboard.js#L25313-L25370) · 58 satır · profiles:update
...
- `openVorlagenAnsicht()` — [dashboard.js:13556](dashboard.js#L13556-L13627) · 72 satır · document_vorlagen:update
- `_enterAnsichtEditMode()` — [dashboard.js:13646](dashboard.js#L13646-L13710) · 65 satır · document_vorlagen:update

**Yol 2 — `saveVorlage()`** · Ekran: _UI yolu çözülemedi_
- `saveVorlage()` — [dashboard.js:13816](dashboard.js#L13816-L13844) · 29 satır · document_vorlagen:update, document_vorlagen:insert

**Yol 3 — `deleteVorlage()`** · Ekran: Sidebar → §302-Abrechnung (physiotherapy/praxis) · Sidebar → Patienten · Sidebar → Team · Sidebar → Vorlagen
- `deleteVorlage()` — [dashboard.js:13846](dashboard.js#L13846-L13853) · 8 satır · document_vorlagen:delete

**Yol 4 — `duplicateVorlage()`** · Ekran: Sidebar → §302-Abrechnung (physiotherapy/praxis) · Sidebar → Patienten · Sidebar → Team · Sidebar → Vorlagen
- `duplicateVorlage()` — [dashboard.js:13855](dashboard.js#L13855-L13869) · 15 satır · document_vorlagen:insert
...
- `startVorlagenInlineRename()` — [dashboard.js:13871](dashboard.js#L13871-L13900) · 30 satır · document_vorlagen:update
- `commit()` — [dashboard.js:13878](dashboard.js#L13878-L13891) · 14 satır · document_vorlagen:update

**Yol 6 — `seedDefaultVorlagen()`** · Ekran: _UI yolu çözülemedi_
- `seedDefaultVorlagen()` — [dashboard.js:13914](dashboard.js#L13914-L13918) · 5 satır · document_vorlagen:insert
...
- `seedMissingVorlagen()` — [dashboard.js:13920](dashboard.js#L13920-L13924) · 5 satır · document_vorlagen:insert
...
- `toggleStandortDay()` — [dashboard.js:10904](dashboard.js#L10904-L10924) · 21 satır · businesses:update

**Yol 2 — `wireBusinessModal()`** · Ekran: _UI yolu çözülemedi_
- `wireBusinessModal()` — [dashboard.js:18043](dashboard.js#L18043-L18124) · 82 satır · businesses:update, businesses:insert

**Yol 3 — `deleteBusiness()`** · Ekran: _UI yolu çözülemedi_
- `deleteBusiness()` — [dashboard.js:18126](dashboard.js#L18126-L18143) · 18 satır · businesses:delete

**Yol 4 — `ensureBusinessCoords()`** · Ekran: Sidebar → §302-Abrechnung (physiotherapy/praxis) · Sidebar → Patienten · Sidebar → Team
- `ensureBusinessCoords()` — [dashboard.js:24745](dashboard.js#L24745-L24774) · 30 satır · businesses:update
...
- `ensureBlankoBonusServices()` — [dashboard.js:7727](dashboard.js#L7727-L7766) · 40 satır · services:update, services:insert

**Yol 2 — `normName()`** · Ekran: _UI yolu çözülemedi_
- `autoSeedGkvServices()` — [dashboard.js:10087](dashboard.js#L10087-L10114) · 28 satır · services:insert
...
- `migratePodologieLegacyServices()` — [dashboard.js:10283](dashboard.js#L10283-L10318) · 36 satır · services:update

**Yol 4 — `renderServices()`** · Ekran: Sidebar → §302-Abrechnung (physiotherapy/praxis) · Sidebar → Patienten · Sidebar → Leistungen · Sidebar → Team
- `renderServices()` — [dashboard.js:10550](dashboard.js#L10550-L10618) · 69 satır · services:delete

**Yol 5 — `wireBusinessModal()`** · Ekran: _UI yolu çözülemedi_
- `wireBusinessModal()` — [dashboard.js:18043](dashboard.js#L18043-L18124) · 82 satır · services:insert

### `prescription_sessions` — 4 bağımsız yazma yolu

**Yol 1 — `handleSessionDrop()`** · Ekran: Sidebar → §302-Abrechnung (physiotherapy/praxis) · Sidebar → Patienten · Sidebar → Team
- `handleSessionDrop()` — [dashboard.js:3994](dashboard.js#L3994-L4090) · 97 satır · prescription_sessions:update

**Yol 2 — `handlePatientNichtErschienen()`** · Ekran: _UI yolu çözülemedi_
- `handlePatientNichtErschienen()` — [dashboard.js:4585](dashboard.js#L4585-L4633) · 49 satır · prescription_sessions:update

**Yol 3 — `markPrescriptionSession()`** · Ekran: _UI yolu çözülemedi_
- `markPrescriptionSession()` — [dashboard.js:7505](dashboard.js#L7505-L7523) · 19 satır · prescription_sessions:update

**Yol 4 — `linkBookingsToPrescriptionSessions()`** · Ekran: _UI yolu çözülemedi_
- `linkBookingsToPrescriptionSessions()` — [dashboard.js:7538](dashboard.js#L7538-L7628) · 91 satır · prescription_sessions:update, prescription_sessions:insert
...
- `loadTeam()` — [dashboard.js:11229](dashboard.js#L11229-L11426) · 198 satır · time_offs:insert
- `openEmpDetail()` — [dashboard.js:11893](dashboard.js#L11893-L12090) · 198 satır · time_offs:insert

**Yol 2 — `deleteEmpTimeOff()`** · Ekran: Sidebar → §302-Abrechnung (physiotherapy/praxis) · Sidebar → Patienten · Sidebar → Team
- `deleteEmpTimeOff()` — [dashboard.js:11497](dashboard.js#L11497-L11511) · 15 satır · time_offs:delete

**Yol 3 — `saveUrlaub()`** · Ekran: _UI yolu çözülemedi_
- `saveUrlaub()` — [dashboard.js:11513](dashboard.js#L11513-L11540) · 28 satır · time_offs:insert

**Yol 4 — `deleteUrlaub()`** · Ekran: _UI yolu çözülemedi_
- `deleteUrlaub()` — [dashboard.js:11571](dashboard.js#L11571-L11578) · 8 satır · time_offs:delete
...
- `renderOtherStandortEmps()` — [dashboard.js:11592](dashboard.js#L11592-L11677) · 86 satır · employee_business_assignments:upsert

**Yol 2 — `renderEmpStandortList()`** · Ekran: Sidebar → §302-Abrechnung (physiotherapy/praxis) · Sidebar → Patienten · Sidebar → Team
- `renderEmpStandortList()` — [dashboard.js:11739](dashboard.js#L11739-L11804) · 66 satır · employee_business_assignments:upsert, employee_business_assignments:delete

**Yol 3 — `saveEmpPermissions()`** · Ekran: Sidebar → §302-Abrechnung (physiotherapy/praxis) · Sidebar → Patienten · Sidebar → Team
- `saveEmpPermissions()` — [dashboard.js:11840](dashboard.js#L11840-L11891) · 52 satır · employee_business_assignments:upsert

### `leads` — 3 bağımsız yazma yolu

**Yol 1 — `handleDirectAusfallrechnung()`** · Ekran: _UI yolu çözülemedi_
- `handleDirectAusfallrechnung()` — [dashboard.js:4635](dashboard.js#L4635-L4779) · 145 satır · leads:update

**Yol 2 — `saveRezept()`** · Ekran: _UI yolu çözülemedi_
- `saveRezept()` — [dashboard.js:17521](dashboard.js#L17521-L17679) · 159 satır · leads:update

**Yol 3 — `initSchnellerfassung()`** · Ekran: _UI yolu çözülemedi_
- `initSchnellerfassung()` — [dashboard.js:22161](dashboard.js#L22161-L22284) · 124 satır · leads:insert
...
- `saveUserPref()` — [dashboard.js:15189](dashboard.js#L15189-L15199) · 11 satır · user_preferences:upsert

**Yol 2 — `switchBusiness()`** · Ekran: _UI yolu çözülemedi_
- `switchBusiness()` — [dashboard.js:18205](dashboard.js#L18205-L18220) · 16 satır · user_preferences:upsert
...
- `deleteAerzte()` — [dashboard.js:16944](dashboard.js#L16944-L16951) · 8 satır · aerzte:delete

**Yol 2 — `editAerzte()`** · Ekran: _UI yolu çözülemedi_
- `editAerzte()` — [dashboard.js:16953](dashboard.js#L16953-L16998) · 46 satır · aerzte:update
...
- `renderHoursGrid()` — [dashboard.js:10928](dashboard.js#L10928-L11001) · 74 satır · breaks:insert, breaks:delete

**Yol 2 — `loadEmpHours()`** · Ekran: Sidebar → §302-Abrechnung (physiotherapy/praxis) · Sidebar → Patienten · Sidebar → Team
- `loadEmpHours()` — [dashboard.js:12184](dashboard.js#L12184-L12274) · 91 satır · breaks:insert, breaks:delete
...
- `loadSettings()` — [dashboard.js:12997](dashboard.js#L12997-L13113) · 117 satır · calendar_integrations:delete
...
- `loadEmpServices()` — [dashboard.js:12276](dashboard.js#L12276-L12360) · 85 satır · employee_services:insert, employee_services:delete
...
- `saveFahrtStartHandler()` — [dashboard.js:4274](dashboard.js#L4274-L4340) · 67 satır · fahrten:upsert

**Yol 2 — `saveFahrtEndHandler()`** · Ekran: _UI yolu çözülemedi_
- `saveFahrtEndHandler()` — [dashboard.js:4401](dashboard.js#L4401-L4493) · 93 satır · fahrten:upsert

### `invoices` — 2 bağımsız yazma yolu

**Yol 1 — `saveInvoice()`** · Ekran: _UI yolu çözülemedi_
- `saveInvoice()` — [dashboard.js:15980](dashboard.js#L15980-L16069) · 90 satır · invoices:update, invoices:insert
...
- `refreshFussbefundVerlauf()` — [dashboard.js:9109](dashboard.js#L9109-L9175) · 67 satır · pat_fussbefund:delete
- `saveFussbefund()` — [dashboard.js:9329](dashboard.js#L9329-L9380) · 52 satır · pat_fussbefund:update, pat_fussbefund:insert
...
- `saveQuickVehicleHandler()` — [dashboard.js:4251](dashboard.js#L4251-L4272) · 22 satır · vehicles:insert

**Yol 2 — `loadFbVehicles()`** · Ekran: ortak yardımcı — 5 modülden çağrılıyor
- `loadFbVehicles()` — [dashboard.js:21261](dashboard.js#L21261-L21322) · 62 satır · vehicles:delete
- `saveVehicleEdit()` — [dashboard.js:21364](dashboard.js#L21364-L21396) · 33 satır · vehicles:update, vehicles:insert
...
- `reportSidebarVisibility()` — [dashboard.js:899](dashboard.js#L899-L923) · 25 satır · visibility_reports:upsert
...
- `loadEmpHours()` — [dashboard.js:12184](dashboard.js#L12184-L12274) · 91 satır · working_hours:upsert
...
- `wireBefreiungCard()` — [dashboard.js:8740](dashboard.js#L8740-L8779) · 40 satır · zuzahlung_befreiung:delete

**Yol 2 — `uploadRxNachweise()`** · Ekran: _UI yolu çözülemedi_
- `uploadRxNachweise()` — [dashboard.js:19114](dashboard.js#L19114-L19200) · 87 satır · zuzahlung_befreiung:update, zuzahlung_befreiung:insert
...
- `init` — attendance.js:297 · booking-request.js:1220 · booking.js:60 · cookie-consent.js:52 · dashboard.js:18268 · kalender.js:140 · onboarding.js:77
...
- `cleanup` — dashboard.js:7053 · dashboard.js:7082 · dashboard.js:7158 · dashboard.js:7269 · dashboard.js:24918
- `g` — dashboard.js:17011 · dashboard.js:17024 · dashboard.js:17366 · dashboard.js:17432 · module/termin-aktionen.js:336
...
- `loadServices` — booking-request.js:419 · booking.js:195 · dashboard.js:10067 · kalender.js:497
- `closeModal` — dashboard.js:1244 · dashboard.js:13174 · dashboard.js:13593 · ops/app.js:162
- `v` — dashboard.js:14098 · dashboard.js:14123 · dashboard.js:14142 · dashboard.js:18054
- `schliessen` — module/abrechnung-freigabe.js:156 · module/abrechnungsstatus.js:319 · module/arzt-register.js:276 · module/zuzahlung-befreiung.js:150
- `load` — ops/board.js:111 · ops/decisions.js:7 · ops/meetings.js:7 · ops/wissen.js:49
- `isAdmin` — admin-login.js:18 · api/_lib/auth.js:90 · login.js:192
- `showToast` — admin.js:22 · dashboard.js:1258 · module/kiosk.js:46
- `main` — api-backend/check_diagnosegruppen_icd.js:94 · api-backend/sync_heilmittel_katalog.js:109 · stripe-live-setup.js:75
- `q` — booking-request.js:84 · dashboard.js:21235 · script.js:751
- `loadTeam` — booking-request.js:517 · dashboard.js:11229 · kalender.js:194
- `initCalendar` — booking-request.js:566 · dashboard.js:2512 · kalender.js:244
- `onEsc` — dashboard.js:7276 · module/rechnung-leistung-picker.js:42 · module/zuzahlung-befreiung.js:155
- `getCb` — dashboard.js:9178 · dashboard.js:9269 · module/fussbefund.js:151
- `norm` — dashboard.js:18434 · module/arzt-register.js:470 · ops/tools/regroup.mjs:59
