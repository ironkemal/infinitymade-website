...
**1754 fonksiyon** · 170 dosya · 39 sidebar modülü
...
- `renderAbrechnungReady()` — [dashboard.js:19695](dashboard.js#L19695-L19926) · 232 satır · prescriptions:update

**Yol 5 — `renderAbrechnungHistory()`** · Ekran: Sidebar → §302-Abrechnung (physiotherapy/praxis) · Sidebar → Patienten · Sidebar → Team
- `renderAbrechnungHistory()` — [dashboard.js:19928](dashboard.js#L19928-L20015) · 88 satır · prescriptions:update
...
- `triggerStorno()` — [dashboard.js:21032](dashboard.js#L21032-L21091) · 60 satır · prescriptions:update
...
- `openStripePortal()` — [dashboard.js:2292](dashboard.js#L2292-L2402) · 111 satır · profiles:update
...
- `initAnfragenPanel()` — [dashboard.js:23466](dashboard.js#L23466-L23523) · 58 satır · profiles:update
...
- `ensureBusinessCoords()` — [dashboard.js:22954](dashboard.js#L22954-L22983) · 30 satır · businesses:update
...
- `initSchnellerfassung()` — [dashboard.js:21607](dashboard.js#L21607-L21730) · 124 satır · leads:insert

### `aerzte` — 2 bağımsız yazma yolu

**Yol 1 — `deleteAerzte()`** · Ekran: _UI yolu çözülemedi_
- `deleteAerzte()` — [dashboard.js:16390](dashboard.js#L16390-L16397) · 8 satır · aerzte:delete

**Yol 2 — `editAerzte()`** · Ekran: _UI yolu çözülemedi_
- `editAerzte()` — [dashboard.js:16399](dashboard.js#L16399-L16444) · 46 satır · aerzte:update
...
- `loadFbVehicles()` — [dashboard.js:20707](dashboard.js#L20707-L20768) · 62 satır · vehicles:delete
- `saveVehicleEdit()` — [dashboard.js:20810](dashboard.js#L20810-L20842) · 33 satır · vehicles:update, vehicles:insert
...
- `reportSidebarVisibility()` — [dashboard.js:916](dashboard.js#L916-L940) · 25 satır · visibility_reports:upsert
...
- `cleanup` — dashboard.js:7010 · dashboard.js:7039 · dashboard.js:7115 · dashboard.js:7219 · dashboard.js:23127
- `g` — dashboard.js:16457 · dashboard.js:16470 · dashboard.js:16812 · dashboard.js:16878 · module/termin-aktionen.js:336
...
- `loadServices` — booking-request.js:419 · booking.js:193 · dashboard.js:9622 · kalender.js:497
- `closeModal` — dashboard.js:1274 · dashboard.js:12612 · dashboard.js:13031 · ops/app.js:162
- `v` — dashboard.js:13536 · dashboard.js:13561 · dashboard.js:13581 · dashboard.js:17500
- `load` — ops/board.js:111 · ops/decisions.js:7 · ops/meetings.js:7 · ops/wissen.js:49
- `isAdmin` — admin-login.js:18 · api/_lib/auth.js:90 · login.js:192
- `showToast` — admin.js:22 · dashboard.js:1288 · module/kiosk.js:46
- `main` — api-backend/check_diagnosegruppen_icd.js:94 · api-backend/sync_heilmittel_katalog.js:109 · stripe-live-setup.js:80
- `q` — booking-request.js:84 · dashboard.js:20681 · script.js:751
- `loadTeam` — booking-request.js:513 · dashboard.js:10669 · kalender.js:194
- `initCalendar` — booking-request.js:562 · dashboard.js:2520 · kalender.js:244
