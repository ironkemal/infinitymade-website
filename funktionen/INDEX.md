...
**2126 fonksiyon** · 225 dosya · 39 sidebar modülü
...
- `openBookingActionModal()` — [dashboard.js:3265](dashboard.js#L3265-L3740) · 476 satır · bookings:update

**Yol 3 — `handleSessionDrop()`** · Ekran: ortak yardımcı — 9 modülden çağrılıyor
- `handleSessionDrop()` — [dashboard.js:3948](dashboard.js#L3948-L4044) · 97 satır · bookings:insert

**Yol 4 — `saveFahrtStartHandler()`** · Ekran: _UI yolu çözülemedi_
- `saveFahrtStartHandler()` — [dashboard.js:4228](dashboard.js#L4228-L4294) · 67 satır · bookings:update

**Yol 5 — `markArrivedHandler()`** · Ekran: _UI yolu çözülemedi_
- `markArrivedHandler()` — [dashboard.js:4311](dashboard.js#L4311-L4325) · 15 satır · bookings:update

**Yol 6 — `saveFahrtEndHandler()`** · Ekran: _UI yolu çözülemedi_
- `saveFahrtEndHandler()` — [dashboard.js:4355](dashboard.js#L4355-L4447) · 93 satır · bookings:update

**Yol 7 — `handleTerminStarten()`** · Ekran: _UI yolu çözülemedi_
- `handleTerminStarten()` — [dashboard.js:4449](dashboard.js#L4449-L4517) · 69 satır · bookings:update

**Yol 8 — `korrigiereNoShow()`** · Ekran: _UI yolu çözülemedi_
- `handlePatientNichtErschienen()` — [dashboard.js:4539](dashboard.js#L4539-L4577) · 39 satır · bookings:update
...
- `loadGroupParticipants()` — [dashboard.js:4830](dashboard.js#L4830-L4908) · 79 satır · bookings:update
- `initBkGroupPatientAutocomplete()` — [dashboard.js:4946](dashboard.js#L4946-L5067) · 122 satır · bookings:insert

**Yol 10 — `doMoveBooking()`** · Ekran: ortak yardımcı — 9 modülden çağrılıyor
- `doMoveBooking()` — [dashboard.js:5412](dashboard.js#L5412-L5441) · 30 satır · bookings:update

**Yol 11 — `absageTerminMitGrund()`** · Ekran: _UI yolu çözülemedi_
- `absageTerminMitGrund()` — [dashboard.js:7854](dashboard.js#L7854-L7890) · 37 satır · bookings:update, bookings:delete
...
- `kassiereZuzahlung()` — [dashboard.js:7172](dashboard.js#L7172-L7244) · 73 satır · prescriptions:update
- `flipAbrechnungStatus()` — [dashboard.js:8474](dashboard.js#L8474-L8510) · 37 satır · prescriptions:update

**Yol 2 — `storniereZuzahlung()`** · Ekran: _UI yolu çözülemedi_
- `storniereZuzahlung()` — [dashboard.js:7247](dashboard.js#L7247-L7315) · 69 satır · prescriptions:update

**Yol 3 — `downloadDmrzForInvoice()`** · Ekran: _UI yolu çözülemedi_
- `downloadDmrzForInvoice()` — [dashboard.js:15438](dashboard.js#L15438-L15513) · 76 satır · prescriptions:update

**Yol 4 — `renderAbrechnungHistory()`** · Ekran: ortak yardımcı — 9 modülden çağrılıyor
- `renderAbrechnungHistory()` — [dashboard.js:18271](dashboard.js#L18271-L18370) · 100 satır · prescriptions:update

**Yol 5 — `triggerStorno()`** · Ekran: ortak yardımcı — 10 modülden çağrılıyor
- `triggerStorno()` — [dashboard.js:19310](dashboard.js#L19310-L19369) · 60 satır · prescriptions:update
...
- `ensureClinicLocation()` — [dashboard.js:5721](dashboard.js#L5721-L5747) · 27 satır · profiles:update

**Yol 3 — `fmt()`** · Ekran: ortak yardımcı — 9 modülden çağrılıyor
- `fmt()` — [dashboard.js:10862](dashboard.js#L10862-L13863) · 3002 satır · profiles:update
- `openEmpDetail()` — [dashboard.js:11194](dashboard.js#L11194-L11391) · 198 satır · profiles:update
- `ensureCompanyCode()` — [dashboard.js:13556](dashboard.js#L13556-L13562) · 7 satır · profiles:update
- `ensureBookingSlug()` — [dashboard.js:13573](dashboard.js#L13573-L13586) · 14 satır · profiles:update
...
- `saveEmployee()` — [dashboard.js:14265](dashboard.js#L14265-L14328) · 64 satır · profiles:insert

**Yol 5 — `initAnfragenPanel()`** · Ekran: ortak yardımcı — 10 modülden çağrılıyor
- `initAnfragenPanel()` — [dashboard.js:21730](dashboard.js#L21730-L21787) · 58 satır · profiles:update
...
- `ensureBlankoBonusServices()` — [dashboard.js:7599](dashboard.js#L7599-L7638) · 40 satır · services:update, services:insert

**Yol 2 — `normName()`** · Ekran: _UI yolu çözülemedi_
- `autoSeedGkvServices()` — [dashboard.js:9507](dashboard.js#L9507-L9534) · 28 satır · services:insert
...
- `migratePodologieLegacyServices()` — [dashboard.js:9703](dashboard.js#L9703-L9738) · 36 satır · services:update

**Yol 4 — `renderServices()`** · Ekran: ortak yardımcı — 9 modülden çağrılıyor
- `renderServices()` — [dashboard.js:9890](dashboard.js#L9890-L9914) · 25 satır · services:delete

**Yol 5 — `wireBusinessModal()`** · Ekran: _UI yolu çözülemedi_
- `wireBusinessModal()` — [dashboard.js:17229](dashboard.js#L17229-L17310) · 82 satır · services:insert
...
- `toggleStandortDay()` — [dashboard.js:10207](dashboard.js#L10207-L10227) · 21 satır · businesses:update

**Yol 2 — `wireBusinessModal()`** · Ekran: _UI yolu çözülemedi_
- `wireBusinessModal()` — [dashboard.js:17229](dashboard.js#L17229-L17310) · 82 satır · businesses:update, businesses:insert

**Yol 3 — `deleteBusiness()`** · Ekran: _UI yolu çözülemedi_
- `deleteBusiness()` — [dashboard.js:17312](dashboard.js#L17312-L17329) · 18 satır · businesses:delete

**Yol 4 — `ensureBusinessCoords()`** · Ekran: ortak yardımcı — 9 modülden çağrılıyor
- `ensureBusinessCoords()` — [dashboard.js:21218](dashboard.js#L21218-L21247) · 30 satır · businesses:update
...
- `handleDirectAusfallrechnung()` — [dashboard.js:4579](dashboard.js#L4579-L4725) · 147 satır · leads:update

**Yol 2 — `maybeOfferAppointmentConfirmEmail()`** · Ekran: _UI yolu çözülemedi_
- `maybeOfferAppointmentConfirmEmail()` — [dashboard.js:7502](dashboard.js#L7502-L7589) · 88 satır · leads:update

**Yol 3 — `initSchnellerfassung()`** · Ekran: _UI yolu çözülemedi_
- `initSchnellerfassung()` — [dashboard.js:19885](dashboard.js#L19885-L20008) · 124 satır · leads:insert
...
- `handleSessionDrop()` — [dashboard.js:3948](dashboard.js#L3948-L4044) · 97 satır · prescription_sessions:update

**Yol 2 — `korrigiereNoShow()`** · Ekran: _UI yolu çözülemedi_
- `handlePatientNichtErschienen()` — [dashboard.js:4539](dashboard.js#L4539-L4577) · 39 satır · prescription_sessions:update
...
- `markPrescriptionSession()` — [dashboard.js:7377](dashboard.js#L7377-L7395) · 19 satır · prescription_sessions:update

**Yol 4 — `linkBookingsToPrescriptionSessions()`** · Ekran: _UI yolu çözülemedi_
- `linkBookingsToPrescriptionSessions()` — [dashboard.js:7410](dashboard.js#L7410-L7500) · 91 satır · prescription_sessions:update, prescription_sessions:insert
...
- `deleteAerzte()` — [dashboard.js:16253](dashboard.js#L16253-L16260) · 8 satır · aerzte:delete

**Yol 3 — `editAerzte()`** · Ekran: _UI yolu çözülemedi_
- `editAerzte()` — [dashboard.js:16262](dashboard.js#L16262-L16307) · 46 satır · aerzte:update

### `fahrten` — 3 bağımsız yazma yolu

**Yol 1 — `saveFahrtStartHandler()`** · Ekran: _UI yolu çözülemedi_
- `saveFahrtStartHandler()` — [dashboard.js:4228](dashboard.js#L4228-L4294) · 67 satır · fahrten:upsert

**Yol 2 — `saveFahrtEndHandler()`** · Ekran: _UI yolu çözülemedi_
- `saveFahrtEndHandler()` — [dashboard.js:4355](dashboard.js#L4355-L4447) · 93 satır · fahrten:upsert

**Yol 3 — `toLocal()`** · Ekran: ortak yardımcı — 10 modülden çağrılıyor
- `toLocal()` — [dashboard.js:18888](dashboard.js#L18888-L18951) · 64 satır · fahrten:update, fahrten:delete
...
- `renderHoursGrid()` — [dashboard.js:10231](dashboard.js#L10231-L10304) · 74 satır · breaks:insert, breaks:delete

**Yol 2 — `fmt()`** · Ekran: ortak yardımcı — 9 modülden çağrılıyor
- `fmt()` — [dashboard.js:10862](dashboard.js#L10862-L13863) · 3002 satır · breaks:insert, breaks:delete
- `loadEmpHours()` — [dashboard.js:11485](dashboard.js#L11485-L11575) · 91 satır · breaks:insert, breaks:delete

### `calendar_integrations` — 2 bağımsız yazma yolu

**Yol 1 — `fmt()`** · Ekran: ortak yardımcı — 9 modülden çağrılıyor
- `fmt()` — [dashboard.js:10862](dashboard.js#L10862-L13863) · 3002 satır · calendar_integrations:delete
- `loadSettings()` — [dashboard.js:12298](dashboard.js#L12298-L12414) · 117 satır · calendar_integrations:delete
...
- `loadPatientDetailMails()` — [dashboard.js:8895](dashboard.js#L8895-L8931) · 37 satır · email_logs:update

**Yol 2 — `fmt()`** · Ekran: ortak yardımcı — 9 modülden çağrılıyor
- `fmt()` — [dashboard.js:10862](dashboard.js#L10862-L13863) · 3002 satır · email_logs:insert

### `employee_services` — 2 bağımsız yazma yolu

**Yol 1 — `fmt()`** · Ekran: ortak yardımcı — 9 modülden çağrılıyor
- `fmt()` — [dashboard.js:10862](dashboard.js#L10862-L13863) · 3002 satır · employee_services:insert, employee_services:delete
- `loadEmpServices()` — [dashboard.js:11577](dashboard.js#L11577-L11661) · 85 satır · employee_services:insert, employee_services:delete
...
**Yol 1 — `fmt()`** · Ekran: ortak yardımcı — 9 modülden çağrılıyor
- `loadTeam()` — [dashboard.js:10532](dashboard.js#L10532-L10727) · 196 satır · time_offs:insert
- `deleteEmpTimeOff()` — [dashboard.js:10798](dashboard.js#L10798-L10812) · 15 satır · time_offs:delete
- `fmt()` — [dashboard.js:10862](dashboard.js#L10862-L13863) · 3002 satır · time_offs:delete, time_offs:insert
- `deleteUrlaub()` — [dashboard.js:10872](dashboard.js#L10872-L10879) · 8 satır · time_offs:delete
- `openEmpDetail()` — [dashboard.js:11194](dashboard.js#L11194-L11391) · 198 satır · time_offs:insert

**Yol 2 — `saveUrlaub()`** · Ekran: _UI yolu çözülemedi_
- `saveUrlaub()` — [dashboard.js:10814](dashboard.js#L10814-L10841) · 28 satır · time_offs:insert

### `user_preferences` — 2 bağımsız yazma yolu

**Yol 1 — `saveUserPref()`** · Ekran: ortak yardımcı — 9 modülden çağrılıyor
- `saveUserPref()` — [dashboard.js:14491](dashboard.js#L14491-L14501) · 11 satır · user_preferences:upsert

**Yol 2 — `switchBusiness()`** · Ekran: _UI yolu çözülemedi_
- `switchBusiness()` — [dashboard.js:17391](dashboard.js#L17391-L17406) · 16 satır · user_preferences:upsert

### `vehicles` — 2 bağımsız yazma yolu

**Yol 1 — `saveQuickVehicleHandler()`** · Ekran: _UI yolu çözülemedi_
- `saveQuickVehicleHandler()` — [dashboard.js:4205](dashboard.js#L4205-L4226) · 22 satır · vehicles:insert

**Yol 2 — `loadFbVehicles()`** · Ekran: ortak yardımcı — 10 modülden çağrılıyor
- `loadFbVehicles()` — [dashboard.js:18987](dashboard.js#L18987-L19048) · 62 satır · vehicles:delete
- `saveVehicleEdit()` — [dashboard.js:19090](dashboard.js#L19090-L19122) · 33 satır · vehicles:update, vehicles:insert
...
- `reportSidebarVisibility()` — [dashboard.js:963](dashboard.js#L963-L987) · 25 satır · visibility_reports:upsert

### `working_hours` — 2 bağımsız yazma yolu

**Yol 1 — `fmt()`** · Ekran: ortak yardımcı — 9 modülden çağrılıyor
- `fmt()` — [dashboard.js:10862](dashboard.js#L10862-L13863) · 3002 satır · working_hours:upsert
- `loadEmpHours()` — [dashboard.js:11485](dashboard.js#L11485-L11575) · 91 satır · working_hours:upsert
...
- `fmt` — dashboard.js:3875 · dashboard.js:8519 · dashboard.js:10495 · dashboard.js:10784 · dashboard.js:10862 · dashboard.js:14579 · dashboard.js:14986 · dashboard.js:20802 · dashboard.js:20888 · dashboard.js:20966 · dashboard.js:20998 · dashboard.js:21058 · module/kalender-raster.js:71 · module/rezeptinfo-geld.js:68
- `fmtDate` — api-backend/billing/dta/encoding.js:47 · api-backend/billing/pdf/ausfallrechnung.template.js:19 · api-backend/billing/pdf/begleitzettel.template.js:28 · api-backend/billing/pdf/mahnung.template.js:6 · api-backend/billing/pdf/rechnung.template.js:11 · api-backend/billing/pdf/rezeptvorderseite.template.js:10 · api-backend/billing/pdf/rzg-quittung.template.js:11 · api-backend/billing/pdf/zuzahlungsrechnung.template.js:14 · dashboard.js:1387 · ops/app.js:84
- `fmtEur` — api-backend/billing/pdf/ausfallrechnung.template.js:15 · api-backend/billing/pdf/begleitzettel.template.js:27 · api-backend/billing/pdf/mahnung.template.js:5 · api-backend/billing/pdf/rechnung.template.js:10 · api-backend/billing/pdf/rzg-quittung.template.js:10 · api-backend/billing/pdf/zuzahlungsrechnung.template.js:13 · dashboard.js:19470 · dashboard.js:19611 · dashboard.js:19689 · module/geld.js:48
- `render` — calendar-widget.js:127 · dashboard.js:13939 · dashboard.js:20618 · ops/board.js:206 · ops/decisions.js:14 · ops/files.js:52 · ops/finance.js:959 · ops/meetings.js:23 · ops/wissen.js:66 · patient-suche.js:116
- `g` — dashboard.js:16320 · dashboard.js:16333 · dashboard.js:16630 · dashboard.js:16701 · module/rezept-in-maske.js:39 · module/verordnung-anlegen.js:28 · module/verordnung-maske.js:324 · module/verordnung-nachweis.js:28
- `addDays` — api-backend/ai/validators/blankoRules.js:29 · api-backend/ai/validators/lhbBvbRules.js:24 · api-backend/ai/validators/standardRules.js:42 · api-backend/billing/api/mahnwesen.routes.js:45 · api-backend/server.js:257 · api-backend/server.js:1284 · dashboard.js:3206
...
- `init` — attendance.js:297 · booking-request.js:1242 · booking.js:58 · cookie-consent.js:139 · dashboard.js:17454 · kalender.js:149 · onboarding.js:77
...
- `cleanup` — dashboard.js:7009 · dashboard.js:7038 · dashboard.js:7141 · dashboard.js:21391 · module/absagegrund-modal.js:81
...
- `loadServices` — booking-request.js:419 · booking.js:193 · dashboard.js:9486 · kalender.js:634
- `speichern` — cookie-consent.js:69 · module/arzt-register.js:292 · module/fussbefund.js:679 · module/verordnung-detail.js:799
- `closeModal` — dashboard.js:1321 · dashboard.js:12475 · dashboard.js:12894 · ops/app.js:162
- `onEsc` — dashboard.js:7148 · module/rechnung-leistung-picker.js:46 · module/zuzahlung-befreiung.js:155 · module/zuzahlung-korrektur.js:214
- `v` — dashboard.js:13399 · dashboard.js:13424 · dashboard.js:13444 · dashboard.js:17240
...
- `showToast` — admin.js:22 · dashboard.js:1335 · module/kiosk.js:46
- `q` — booking-request.js:84 · dashboard.js:18961 · script.js:751
- `loadTeam` — booking-request.js:513 · dashboard.js:10532 · kalender.js:238
- `initCalendar` — booking-request.js:562 · dashboard.js:2568 · kalender.js:288
