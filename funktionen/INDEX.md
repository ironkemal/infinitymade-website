...
- `initAnfragenPanel()` — [dashboard.js:20767](dashboard.js#L20767-L20824) · 58 satır · profiles:update
...
- `triggerStorno()` — [dashboard.js:18371](dashboard.js#L18371-L18430) · 60 satır · prescriptions:update
...
- `wireBusinessModal()` — [dashboard.js:16470](dashboard.js#L16470-L16551) · 82 satır · businesses:update, businesses:insert

**Yol 3 — `deleteBusiness()`** · Ekran: _UI yolu çözülemedi_
- `deleteBusiness()` — [dashboard.js:16553](dashboard.js#L16553-L16570) · 18 satır · businesses:delete

**Yol 4 — `ensureBusinessCoords()`** · Ekran: ortak yardımcı — 28 modülden çağrılıyor
- `ensureBusinessCoords()` — [dashboard.js:20255](dashboard.js#L20255-L20284) · 30 satır · businesses:update
...
- `initSchnellerfassung()` — [dashboard.js:18919](dashboard.js#L18919-L19042) · 124 satır · leads:insert
...
- `wireBusinessModal()` — [dashboard.js:16470](dashboard.js#L16470-L16551) · 82 satır · services:insert
...
- `toLocal()` — [dashboard.js:17947](dashboard.js#L17947-L18010) · 64 satır · fahrten:update, fahrten:delete

### `podologie_behandlungen` — 3 bağımsız yazma yolu

**Yol 1 — `loadPodologieBilling()`** · Ekran: ortak yardımcı — 28 modülden çağrılıyor
- `loadPodologieBilling()` — [module/podologie-abrechnung.js:402](module/podologie-abrechnung.js#L402-L824) · 423 satır · podologie_behandlungen:insert
...
- `switchBusiness()` — [dashboard.js:16632](dashboard.js#L16632-L16647) · 16 satır · user_preferences:upsert
...
- `loadFbVehicles()` — [dashboard.js:18046](dashboard.js#L18046-L18107) · 62 satır · vehicles:delete
- `saveVehicleEdit()` — [dashboard.js:18149](dashboard.js#L18149-L18181) · 33 satır · vehicles:update, vehicles:insert
...
- `render` — calendar-widget.js:127 · dashboard.js:13552 · dashboard.js:19647 · ops/board.js:206 · ops/decisions.js:14 · ops/files.js:52 · ops/finance.js:959 · ops/meetings.js:23 · ops/wissen.js:66 · patient-suche.js:116
...
- `init` — attendance.js:296 · booking-request.js:1246 · booking.js:58 · cookie-consent.js:139 · dashboard.js:16695 · kalender.js:155 · onboarding.js:77 · setup.js:225
